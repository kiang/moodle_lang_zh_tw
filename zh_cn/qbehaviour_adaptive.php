...
/**
 * Strings for component 'qbehaviour_adaptive', language 'zh_cn', branch 'MOODLE_21_STABLE'
 *
...
$string['gradingdetailsadjustment'] = '减去之前的罚分，此次得分<strong>{$a->cur}/{$a->max}</strong>。';
