...
/**
 * Strings for component 'report_customlang', language 'zh_cn', branch 'MOODLE_21_STABLE'
 *
...
$string['checkout'] = '打开语言包并编辑';
$string['checkoutdone'] = '语言包已加载';
$string['checkoutinprogress'] = '正加载语言包';
$string['confirmcheckin'] = '即将把修改过的字符串保存到您本地语言包中。这将从翻译器导出自定义的字符串到数据目录中，然后Moodle会开始使用这些修改过的字符串。按“继续”按钮开始保存。';
...
$string['modifiedno'] = '没有需要保存的已改动字符串。';
$string['modifiednum'] = '有 {$a} 条修改过的字符串。您想把它们保存到您本地的语言包吗？';
...
$string['savecheckin'] = '保存修改到语言包';
$string['savecontinue'] = '生效修改并继续编辑';
