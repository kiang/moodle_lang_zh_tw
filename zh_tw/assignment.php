...
$string['allownotes_help'] = '如果啟用，學生可以在一個文字框里輸入備註，和在線文字作業類似。';
...
$string['enablenotification_help'] = '如果啟用，那麼評分後，學生能收到Email通知。';
...
$string['helpupload'] = '<p>這種類型的作業允許每個參與者上傳任何類型的一個或多個文件。它們可以是Word文件，圖片，打包了的網站，或者任何您想讓他們提交的。</p> <p>此類作業也允許您上傳多個反饋文件。反饋文件也可以在作業提交前就上傳，這樣可以給每個參與者不同的文件。</p> <p>參與者們也可以輸入註釋來說明提交的文件、進度狀況或任何其它文字資訊。</p> <p>此類作業的提交必由參與者手動設定為結束。您可以在任何時間檢查當前的狀態，未完成的作業會被標記為草稿。您可以把任何未打分的作業恢復成草稿的狀態。</p>';
...
$string['hideintro_help'] = '如果啟用，在「開放時間」未到時，會隱藏作業描述，只顯示作業名。';
...
$string['page-mod-assignment-submissions'] = '作業模組評分頁';
$string['page-mod-assignment-view'] = '作業模組主頁';
$string['page-mod-assignment-x'] = '任意作業模組頁面';
$string['pagesize'] = '每頁顯示的作業份數';
$string['pluginadministration'] = '作業管理';
$string['pluginname'] = '作業 (2.2)';
$string['popupinnewwindow'] = '在彈出視窗中打開';
...
$string['trackdrafts_help'] = '通過「發送評分請求」按鈕，學生可以通知教師他們已經完成了作業。如需要，教師可以將作業恢復到草稿狀態（比如，該作業還需進一步完善）。';
$string['typeblog'] = '部落格發布';
...
$string['usermisconf'] = '使用者配置錯誤';
$string['usernosubmit'] = '抱歉，您沒有提交作業的權限。';
