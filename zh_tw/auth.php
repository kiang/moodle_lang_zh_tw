...
$string['authinstructions'] = '您可以在這裏提供自訂的登入指示給您的用戶。您在這裏輸入的文本將出現在登入頁面。
...
$string['auth_passwordisexpired'] = '您的密碼已過期，你現在要變更你的密碼嗎?';
...
$string['changepasswordhelp'] = '請輸入當用戶忘記自己的用戶名稱/密碼時，可以找回或更改它們的網址。

此網址將以按鈕形式提供於登入頁面和他們的用戶頁面上，若你未提供網址，則不會出現此按鈕。';
...
$string['emailupdatemessage'] = '親愛的 {$a->fullname}您好，你已經在t{$a->site}變更你帳號的E-mail位址，請在瀏覽器開啟下列網址確認這個變更。';
...
$string['selfregistration_help'] = '若選擇一個認證插件，比如，用email，或自我註冊，那將讓潛在用戶能自行註冊和建立帳號。
