...
/**
 * Strings for component 'auth_fc', language 'zh_tw', branch 'MOODLE_23_STABLE'
 *
 * @package   auth_fc
...
$string['auth_fcdescription'] = '這個方法使用一個第一層伺服器檢查帳號稱與密碼是否有效';
$string['auth_fcfppport'] = '伺服器連結埠(通常是3333)';
$string['auth_fcfppport_key'] = '連結埠';
...
$string['auth_fcuserid_key'] = '使用者帳號';
