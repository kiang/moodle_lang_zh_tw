...
$string['auth_ntlmsso_type'] = 'Web服務器中設置的用戶認證方法（如果不知道該添什麼，就選NTLM）';
$string['auth_ntlmsso_type_key'] = '認證類型';
$string['connectingldap'] = '正在連接LDAP服務器...';
$string['creatingtemptable'] = '正在創建臨時表{$a}';
...
$string['morethanoneuser'] = '詭異！在LDAP中找到多於一條的用戶記錄。只使用第一條。';
...
$string['notcalledfromserver'] = '不應從web服務器調用！';
...
$string['pluginnotenabled'] = '插件未啟用！';
$string['renamingnotallowed'] = 'LDAP不允許用戶重命名';
$string['rootdseerror'] = '活動牡蠣查詢rootDSE出錯';
$string['updatepasserror'] = 'user_update_password()出錯。錯誤代碼：{$a->errno}；錯誤信息：{$a->errstring}';
$string['updatepasserrorexpire'] = 'user_update_password()讀取密碼期限時出錯。錯誤代碼：{$a->errno}；錯誤信息：{$a->errstring}';
$string['updatepasserrorexpiregrace'] = 'user_update_password()修改密碼期限和/或寬限登錄時出錯。錯誤代碼：{$a->errno}；錯誤信息：{$a->errstring}';
$string['updateremfail'] = '更新LDAP記錄出錯。錯誤代碼：{$a->errno}；錯誤信息：{$a->errstring}<br />鍵值（{$a->key}）- 舊moodle值：“{$a->ouvalue}”，新值：“{$a->nuvalue}”';
$string['updateremfailamb'] = '無法使用不明確的字段{$a->key}更新LDAP - 舊moodle值：“{$a->ouvalue}”，新值：“{$a->nuvalue}”';
$string['updateusernotfound'] = '在外部更新時找不到用戶。細節信息：搜索基：“{$a->userdn}”；搜索過濾器：“(objectClass=*)”；搜索屬性：{$a->attribs}';
$string['useracctctrlerror'] = '獲得{$a}的userAccountControl時出錯';
$string['user_activatenotsupportusertype'] = '認證：ldap user_activate()不支持所選的用戶類型：{$a}';
$string['user_disablenotsupportusertype'] = '認證：ldap user_disable()不支持所選的用戶類型：{$a}';
$string['userentriestoadd'] = '要添加的用戶項：{$a}';
$string['userentriestoremove'] = '要刪除的用戶項：{$a}';
$string['userentriestorevive'] = '要恢復的用戶項：{$a}';
$string['userentriestoupdate'] = '要更新的用戶項：{$a}';
