...
$string['configgeneraluserscompletion'] = '預設為將用戶完成訊息包含在備份檔';
...
$string['confirmnewcoursecontinuequestion'] = '在課程回存過程中，將會建立一暫時性(隱藏的)課程。

要放棄回存，請擊點"取消"。

請不要在回存過程中關閉瀏覽器。';
$string['coursecategory'] = '課程恢復時的分類';
...
$string['dependenciesenforced'] = '由於未滿足的依賴關係，您的設置已被更改。';
...
$string['errorfilenamemustbezip'] = '你輸入的檔名必須是一壓縮檔，並以 .mbz 為附檔名。';
$string['errorfilenamerequired'] = '你必須為這一備份輸入一有效的檔案名稱。';
$string['errorinvalidformat'] = '未知的備份格式';
$string['errorinvalidformatinfo'] = '這選出的檔案不是有效的Moodle備份檔，且無法回存。';
$string['errorminbackup20version'] = '這一備份檔是以Moodle備份模組的測試版本({$a->backup})建立。

最低需求是 {$a->min}，無法被回存。';
$string['errorrestorefrontpage'] = '錯誤! 不允許回存超過首頁';
...
$string['locked'] = '已被封鎖';
$string['lockedbyconfig'] = '這一設定是因為預設的備份設定，而被鎖住。';
...
$string['moreresults'] = '有太多結果，請輸入一更詳細的搜尋';
...
$string['qcategorycannotberestored'] = '這試題類別 "{$a->name}" 無法以回存建立';
$string['question2coursefallback'] = '在備份檔中的原來位於系統/課程類別脈絡的試題類別"{$a->name}"，在回存時將會被建立在課程脈絡。';
$string['questionegorycannotberestored'] = '這試題"{$a->name}" 無法經由回存建立。';
...
$string['restoretocurrentcoursedeleting'] = '刪除這一課程的內容，然後用備份檔回存';
$string['restoretoexistingcourse'] = '回存到一現有課程';
$string['restoretoexistingcourseadding'] = '合併這備份課程到這一現有課程';
$string['restoretoexistingcoursedeleting'] = '刪除這現有課程的內容，然後用備份檔回存';
...
$string['rootsettinganonymize'] = '匿名的用戶訊息';
...
$string['rootsettingroleassignments'] = '包含用戶指派';
$string['rootsettings'] = '備份設定';
$string['rootsettingusers'] = '包含有選修的用戶';
$string['rootsettinguserscompletion'] = '包含用戶完成細節';
