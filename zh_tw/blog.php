...
$string['cannotviewuserblog'] = '您沒有閱讀用戶部落格的權限';
$string['configexternalblogcrontime'] = 'Moodle多久檢查一次外部部落格的新文章。';
$string['configmaxexternalblogsperuser'] = '每一用戶可以允許有幾篇外部部落格文章鏈結到他們的Moodle部落格中。';
...
$string['maxexternalblogsperuser'] = '每位用戶最多允許使用幾篇外部部落格文章';
...
$string['relatedblogentries'] = '關部落格文章';
...
$string['viewallmyentries'] = '檢視所有我貼的文章';
$string['viewblogentries'] = '視關於此{$a->type}的所有文章';
