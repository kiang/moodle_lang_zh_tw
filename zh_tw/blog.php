...
/**
 * Strings for component 'blog', language 'zh_tw', branch 'MOODLE_23_STABLE'
 *
 * @package   blog
...
$string['configuseexternalblogs'] = '允許使用者指定外部部落格的來源。Moodle會週期性檢查部落格來源中的新文章，將其拷貝到使用者的本地部落格。';
...
$string['emptyrssfeed'] = '您輸入的網址沒有指向一個有效的 RSS feed';
$string['emptytitle'] = '部落格標題不能空白';
$string['emptyurl'] = '您必須指定一網址給一有效的RSS feed';
...
$string['mustassociatecourse'] = '如果您想出版給一課程或全體成員看，您必須將這文章與一課程相關聯';
$string['name'] = '名稱';
$string['name_help'] = '輸入您的外部部落格的名稱（如果不提供名稱，會直接使用外部部落格的標題）。';
$string['noentriesyet'] = '目前沒有內容';
$string['noguestpost'] = '訪客無法發佈部落格文章！';
$string['nopermissionstodeleteentry'] = '您沒有刪除這篇部落格文章的權限';
...
$string['publishtogroup'] = '與您同一個群組的使用者';
...
$string['url_help'] = '輸入您的外部部落格的 RSS feed';
...
$string['viewentriesbyuseraboutcourse'] = '檢視使用者 {$a}寫的關於這課程的文章';
...
$string['viewuserentries'] = '檢視使用者{$a}的所有文章';
