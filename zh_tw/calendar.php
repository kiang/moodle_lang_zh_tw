...
$string['calendarpreferences'] = '日歷偏好';
$string['calendarurl'] = '日歷URL： {$一';
...
$string['hidden'] = '隱藏';
$string['ical'] = 'iCal';
$string['invalidtimedurationminutes'] = '您輸入的持續時間分鍾數是無效的。請輸入大於0的數，或者選擇不持續�一';
$string['invalidtimedurationuntil'] = '您為“持續直到”選擇的時間和日期早於此事件的開始時間。請在繼續處理前，糾正它�一';
...
$string['pref_lookahead_help'] = '這裡設置未來多少天內會發生的事件被顯示為即將發生的事件。此天數以後發生的事件不會被顯示為將發生。請注意，<strong>並不保證</strong>在此時間窗口內開始的事件會被顯示；如果有太多（超過“將發生事件數最大值”設置），那麼最遠的事件不會被顯示�一';
$string['pref_maxevents'] = '最多顯示幾件即將來臨的事件';
$string['pref_maxevents_help'] = '這裡設置可以顯示的即將發生事件的最大條數。如果您選了一個較大的數字，那麼可能顯示出的事件將占據您屏幕很大的空間�一';
$string['pref_persistflt'] = '記住過濾器的設定';
$string['pref_persistflt_help'] = '如果啟用，Moodle會保存您最後一次使用的事件過濾設置，並在您每次登錄時自動應用�一';
$string['pref_startwday'] = '每星期的第一天';
$string['pref_startwday_help'] = '日歷裡的星期將從您選擇的那天開始�一';
$string['pref_timeformat'] = '時間顯示格式';
$string['pref_timeformat_help'] = '您可以選擇使用12小時或24小時格式。如果您選擇“默認”，系統將根據您所使用的語言自動為您選擇時間格式�一';
$string['quickdownloadcalendar'] = '快速 下載/訂閱 行事曆';
$string['recentupcoming'] = '最近與未來六十天';
$string['repeatedevents'] = '重復事件';
$string['repeateditall'] = '變更系列事件中所有{$a} 的事件';
$string['repeateditthis'] = '只變更這個事件';
$string['repeatevent'] = '重復此事件';
