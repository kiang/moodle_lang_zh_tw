...
$string['chat:exportparticipatedsession'] = '匯出您參加過的聊天會話';
$string['chat:exportsession'] = '匯出所有聊天會話';
...
$string['modulename_help'] = '在聊天室模組中，參與者可以通過web進行實時、同步的討論。與異步的討論區相比，聊天室模式完全不同，對增進了解、深入話題很有幫助。';
...
$string['oldping'] = '逾時斷線';
$string['page-mod-chat-x'] = '任意聊天模組頁面';
...
$string['studentseereports_help'] = '如果選否，那麼只有具有mod/chat:readlog權限的使用者可以看到聊天歷史';
$string['talk'] = '交談';
