...
/**
 * Strings for component 'choice', language 'zh_tw', branch 'MOODLE_23_STABLE'
 *
 * @package   choice
...
$string['completionsubmit'] = '使用者投票後顯示為完成';
...
$string['modulename_help'] = '在投票模組中，教師可以提出一個問題，並給出多個應答選項。';
$string['modulenameplural'] = '意見調查';
$string['moveselectedusersto'] = '移動所選的使用者到...';
...
$string['notenrolledchoose'] = '抱歉，只有已選課的使用者可以投票。';
$string['notopenyet'] = '抱歉,這個活動在{$a}前不開放';
$string['numberofuser'] = '使用者數';
$string['numberofuserinpercentage'] = '使用者數百分比';
$string['option'] = '選項';
$string['page-mod-choice-x'] = '任意投票模組頁面';
...
$string['userchoosethisoption'] = '選擇此選項的使用者';
