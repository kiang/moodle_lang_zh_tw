...
/**
 * Strings for component 'data', language 'zh_tw', branch 'MOODLE_23_STABLE'
 *
 * @package   data
...
$string['csvwithselecteddelimiter'] = '<acronym title="Comma Separated Values">CSV</acronym> 文字採用的分隔符號號：';
...
$string['delete'] = '刪除';
$string['deleteallentries'] = '刪除所有項目';
$string['deletecomment'] = '您確定要刪除這個評論';
$string['deleted'] = '已刪除';
$string['deletefield'] = '刪除現有欄位';
$string['deletenotenrolled'] = '刪除未選課者的項目';
...
$string['entries'] = '資料';
$string['entrieslefttoadd'] = '在您瀏覽其他參與者項目前，您必須增加{$a->entriesleft}更多項目。';
