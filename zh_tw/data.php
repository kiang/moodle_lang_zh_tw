...
$string['availabletags_help'] = '<p align="center"><strong>可用的標簽</strong></p>
...
$string['data:exportallentries'] = '導出所有數據庫條目';
$string['data:exportentry'] = '導出一條數據庫條目';
$string['data:exportownentry'] = '導出自己的數據庫條目';
...
$string['entrieslefttoaddtoview'] = '在查看其他參與者的條目前，您還需添加 {$a} 條目';
$string['entry'] = '資料';
...
$string['page-mod-data-x'] = '任意數據庫活動模塊頁面';
...
$string['subplugintype_datafield'] = '數據庫字段類型';
$string['subplugintype_datafield_plural'] = '數據庫字段類型';
...
$string['uploadrecords_help'] = '可以通過上傳文本文件來更新條目。文件的格式如下：
