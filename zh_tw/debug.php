...
$string['authpluginnotfound'] = '未找到身份認證外掛 {$a}。';
...
$string['configmoodle'] = 'Moodle尚未配置好，您需要首先編輯config.php文件。';
...
$string['nopageclass'] = '已匯入{$a}，但是未找到頁面類';
$string['noreports'] = '沒有可訪問的報告';
$string['notables'] = '無表！';
$string['phpvaroff'] = 'PHP伺服器變量 \'{$a->name}\' 應設置為 Off - {$a->link}';
$string['phpvaron'] = 'PHP伺服器變量」{$a->name}「未開啟 - {$a->link}';
$string['sessionmissing'] = '對象{$a}在會話中遺失';
