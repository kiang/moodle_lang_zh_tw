...
$string['advanced:clipboard_msg'] = '复制、剪切及粘贴功能在Mozilla和Firefox中无法使用。 n是否需要了解更多有关此问题的資訊？';
...
$string['advanced_dlg:about_loaded'] = '已載入的外掛';
$string['advanced_dlg:about_plugin'] = '外掛';
$string['advanced_dlg:about_plugins'] = '所有外掛';
...
$string['advanced_dlg:charmap_title'] = '插入特殊字元';
...
$string['advanced_dlg:link_target_blank'] = '新視窗';
$string['advanced_dlg:link_target_same'] = '同一視窗';
...
$string['advimage_dlg:mouseout'] = '滑鼠划出';
$string['advimage_dlg:mouseover'] = '滑鼠划入';
...
$string['advlink_dlg:popup'] = 'Javascript快显視窗';
...
$string['advlink_dlg:popup_name'] = '視窗名称';
$string['advlink_dlg:popup_opts'] = '选项';
$string['advlink_dlg:popup_position'] = '坐标(X/Y)';
$string['advlink_dlg:popup_props'] = '視窗属性';
$string['advlink_dlg:popup_resizable'] = '可调整視窗尺寸';
...
$string['advlink_dlg:popup_tab'] = '快显視窗';
$string['advlink_dlg:popup_toolbar'] = '显示工具列';
$string['advlink_dlg:popup_url'] = '視窗网址';
...
$string['advlink_dlg:target_blank'] = '打开在新視窗';
$string['advlink_dlg:target_langcode'] = '目标语言';
$string['advlink_dlg:target_name'] = '目标名称';
$string['advlink_dlg:target_parent'] = '打开在父視窗/框架';
$string['advlink_dlg:target_same'] = '打开在新視窗/框架';
...
$string['autosave:warning_message'] = '如果您恢復已保存的內容，您將失去目前正在編輯的內容。
...
$string['common:clipboard_msg'] = '复制、剪切、粘贴功能在Mozilla和Firefox中无法使用。n是否需要了解更多有关此问题的資訊？';
...
$string['common:popup_blocked'] = '抱歉！快显視窗已被阻止，请调整浏览器设置，允许此网站可弹出新視窗，以便使用此工具';
...
$string['dragmath:dragmath_javaneeded'] = '若要使用此網頁，您需要一個支持Java的瀏覽器。從{$a}下載最新的Java外掛。
';
...
$string['fullpage_dlg:encoding'] = '字元编码';
...
$string['fullpage_dlg:meta_props'] = '标签( Meta )資訊';
...
$string['fullscreen:desc'] = '开关全視窗模式';
...
$string['media_dlg:fullscreen'] = '全視窗';
...
$string['media_dlg:qt_stream_warn'] = '流式rtsp资源应该新增到「高级」中QT Src。n同时新增非流式资源到Src。';
...
$string['moodlenolink:desc'] = '禁止自動連結';
$string['nonbreaking:nonbreaking_desc'] = '插入空格';
$string['pagebreak:desc'] = '插入分页符号';
$string['paste_dlg:text_linebreaks'] = '保留分行符号号';
$string['paste_dlg:text_title'] = '在键盘上同时按下CTRL和V键，以粘贴文字到此視窗。';
$string['paste_dlg:word_title'] = '在键盘上同时按下CTRL和V键，以粘贴文字到此視窗。';
$string['paste:paste_text_desc'] = '以纯文字粘贴';
$string['paste:paste_word_desc'] = '从Word粘贴';
$string['paste:plaintext_mode'] = '貼上現在工作在純文字模式。再次點擊切換回普通的貼上模式。';
$string['paste:plaintext_mode_sticky'] = '貼上現在工作在純文字模式。再次點擊切換回正常貼上模式。貼上過一次之後，也會回到正常貼上模式。';
...
$string['searchreplace_dlg:allreplaced'] = '已替换所有辨識的字元串。';
...
$string['searchreplace_dlg:notfound'] = '查找已完成!没有找到辨識项。';
...
$string['style_dlg:block_letterspacing'] = '字元间距';
...
$string['visualchars:desc'] = '显示/隐藏不可见字元';
