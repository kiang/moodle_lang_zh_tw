...
$string['amount'] = '數量';
$string['anauthcode'] = '獲取驗證碼';
$string['anauthcodedesc'] = '如果使用者的信用卡不能在因特網上直接獲取，從使用者的銀行獲取手機驗證碼';
$string['anavs'] = '地址驗證系統';
$string['anavsdesc'] = '如果您的 Authorize.Net merchant 帳戶中已啟用地址驗證系統，請選擇這項。這會要求使用者在填寫支付表格時填寫地址資訊，如街道，州，國家以及郵政編碼等。';
$string['ancaptureday'] = '獲取的日期';
$string['ancapturedaydesc'] = '自動捕獲信用卡，除非老師或管理員審查指定天數之內的訂單。必須啟用CRON。 <br /> （0天，意味著它會停用預定捕獲，也意味著教師或管理員需要手動審查訂單。如果您停用了預定捕獲，或這您沒有在30天內審查，那麼交易將被取消。）';
$string['anemailexpired'] = '超期通知';
$string['anemailexpireddesc'] = '這對手動捕獲很有幫助，管理員會被通知訂單到期前指定的天數。';
$string['anemailexpiredteacher'] = '超期通知-教師';
$string['anemailexpiredteacherdesc'] = '如果您已啟用手動捕獲（見上文），教師可以管理付款，他們也可能被通知有關訂單到期。這將給每門課程的教師發送一封電子郵件，關於訂單到期的數量。';
...
$string['anrefererdesc'] = '定義參考的連結，如果您已經設置了Authorize.Net商業帳戶。這將在Web請求中發送一行「Referer：URL」。';
$string['anreview'] = '審查';
$string['anreviewdesc'] = '在處理信用卡交易之前，重新查看定單。';
$string['antestmode'] = '以測試模式執行交易(沒有真正的金錢交易)';
$string['antestmodedesc'] = '僅以測試模式進行交易（沒有錢的流出）';
$string['antrankey'] = 'Authorize.net: 交易金鑰';
$string['approvedreview'] = '再檢視通過審核的';
$string['authcaptured'] = '取得授權';
$string['authcode'] = '授權碼';
$string['authorize:config'] = '配置Authorize.Net選課實例';
$string['authorizedpendingcapture'] = '授權與等待擷取';
$string['authorizeerror'] = 'Authorize.Net 錯誤: {$a}';
$string['authorize:manage'] = '管理已選課使用者';
$string['authorize:managepayments'] = '管理付款';
$string['authorize:unenrol'] = '從課程取消使用者選課';
$string['authorize:unenrolself'] = '撤銷自己的選課';
...
$string['messageprovider:authorize_enrolment'] = 'Authorize.Net 選課消息';
$string['methodcc'] = '信用卡';
$string['methodccdesc'] = '選擇信用卡，下面是可使用的類型';
$string['methodecheck'] = 'eCheck (ACH)';
$string['methodecheckdesc'] = '選擇 eCheck，下面是可使用的類型';
...
$string['missingccexpiremonth'] = '過期月份缺失';
$string['missingccexpireyear'] = '過期年份缺失';
...
$string['new'] = '新的';
$string['nocost'] = '通過Authorize.Net加入本課程沒有費用！';
$string['noreturns'] = '沒有返回訊息！';
$string['notsettled'] = '未結帳';
$string['orderdetails'] = '訂單詳情';
$string['orderid'] = '訂單編號';
...
$string['reason30'] = '處理器的配置有問題。聯繫商業服務的提供者。';
$string['reason39'] = '提供的流通代碼或者是有問題的，不被支持的，不被允許的或者是沒有兌換率';
...
$string['reason51'] = '這個交易的所有的信用數目大於設定的交易數目';
$string['reason54'] = '交易不標準因為信用卡';
$string['reason55'] = '信用的數目與參考交易相比超過了原定的數量';
$string['reason56'] = '這個商店只接收電子核查（ACH）交易；不接收信用卡交易。';
$string['refund'] = '退款';
$string['refunded'] = '已退款';
$string['returns'] = '返回';
$string['reviewfailed'] = '回顧失敗的';
$string['reviewnotify'] = '您的支付將被回復，幾天內您的老師回給您一封郵件';
$string['sendpaymentbutton'] = '確認付款';
$string['settled'] = '已結帳';
$string['settlementdate'] = '結帳的日期';
$string['shopper'] = '顧客';
$string['status'] = '啟用Authorize.Net選課';
$string['subvoidyes'] = '請確認歸還交易 {$a->transid} 將被取消，您的帳戶將有 {$a->amount}';
$string['tested'] = '測試';
$string['testmode'] = '[測試模式]';
$string['testwarning'] = '獲取/空的/信用工作在測試模式，但是資料庫中沒有更新記錄';
$string['transid'] = '交易ID';
$string['underreview'] = '回顧中';
$string['unenrolselfconfirm'] = '您確定要撤銷您自己對「{$a}」課程的選課嗎？';
$string['unenrolstudent'] = '未註冊的學生？';
$string['uploadcsv'] = '上傳CSV檔案';
$string['usingccmethod'] = '登記使用<a href="{$a->url}"><strong>信用卡</strong></a>';
$string['usingecheckmethod'] = '登記使用<a href="{$a->url}"><strong>電子核查</strong></a>';
$string['verifyaccount'] = '驗證您的 Authorize.Net merchant 帳戶';
$string['verifyaccountresult'] = '<br>驗證結果：</br>{$a}';
$string['void'] = '無效的';
$string['voidyes'] = '這交易將被取消，您確定嗎？';
$string['welcometocoursesemail'] = '親愛的同學， 感謝您的付款。您已經注冊了這些課程： {$a->courses} 您可以編輯個人資料： {$a->profileurl} 您可以查看您的付款細目: {$a->paymenturl}';
