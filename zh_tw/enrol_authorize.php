...
$string['anavs'] = '地址驗證系統';
$string['anavsdesc'] = '如果您的 Authorize.Net merchant 帳戶中已激活地址驗證系統，請選擇這項。這會要求用戶在填寫支付表格時填寫地址信息，如街道，州，國家以及郵政編碼等�一';
$string['ancaptureday'] = '獲取的日期';
$string['ancapturedaydesc'] = '自動捕獲信用卡，除非老師或管理員審查指定天數之內的訂單。必須啟用CRON。 <br /> （0天，意味著它會禁用預定捕獲，也意味著教師或管理員需要手動審查訂單。如果您禁用了預定捕獲，或這您沒有在30天內審查，那麼交易將被取消。�一';
$string['anemailexpired'] = '超期通知';
$string['anemailexpireddesc'] = '這對手動捕獲很有幫助，管理員會被通知訂單到期前指定的天數�一';
$string['anemailexpiredteacher'] = '超期通知-教師';
$string['anemailexpiredteacherdesc'] = '如果您已啟用手動捕獲（見上文），教師可以管理付款，他們也可能被通知有關訂單到期。這將給每門課程的教師發送一封電子郵件，關於訂單到期的數量�一';
...
$string['anrefererdesc'] = '定義參考的鏈接，如果您已經設置了Authorize.Net商業帳戶。這將在Web請求中發送一行“Referer：URL”�一';
$string['anreview'] = '審查';
$string['anreviewdesc'] = '在處理信用卡交易之前，重新查看定單�一';
$string['antestmode'] = '以測試模式執行交易(沒有真正的金錢交易)';
$string['antestmodedesc'] = '僅以測試模式進行交易（沒有錢的流出�一';
...
$string['authorizeerror'] = 'Authorize.Net 錯誤: {$一';
...
$string['cutofftimedesc'] = '交易截止時間，當要達成最後一筆交易�一';
...
$string['isbusinesschecking'] = '是商業訂單嗎�一';
...
$string['new'] = '新的';
$string['nocost'] = '通過Authorize.Net加入本課程沒有費用�一';
...
$string['pluginname'] = 'Authorize.N一';
...
$string['reason30'] = '處理器的配置有問題。聯系商業服務的提供者�一';
$string['reason39'] = '提供的流通代碼或者是有問題的，不被支持的，不被允許的或者是沒有兌換率';
$string['reason43'] = '在處理器中錯誤的建立了店主。聯系商業服務的提供者�一';
...
$string['reason56'] = '這個商店只接收電子核查（ACH）交易；不接收信用卡交易�一';
$string['refund'] = '退款';
$string['refunded'] = '已退款';
$string['returns'] = '返回';
...
$string['subvoidyes'] = '請確認歸還交易 {$a->transid} 將被取消，您的帳戶將有 {$a->amoun一';
$string['tested'] = '測試';
$string['testmode'] = '[測試模式]';
$string['testwarning'] = '獲取/空的/信用工作在測試模式，但是數據庫中沒有更新記錄';
$string['transid'] = '交易ID';
$string['underreview'] = '回顧中';
$string['unenrolselfconfirm'] = '您確定要撤銷您自己對“{$a}”課程的選課嗎�一';
$string['unenrolstudent'] = '未註冊的學生？';
$string['uploadcsv'] = '上傳CSV檔案';
$string['usingccmethod'] = '登記使用<a href="{$a->url}"><strong>信用卡</strong></一';
$string['usingecheckmethod'] = '登記使用<a href="{$a->url}"><strong>電子核查</strong></一';
$string['verifyaccount'] = '驗證您的 Authorize.Net merchant 帳戶';
$string['verifyaccountresult'] = '<br>驗證結果：</br>{$一';
$string['void'] = '無效的';
