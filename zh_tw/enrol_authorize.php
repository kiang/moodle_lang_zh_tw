...
$string['anauthcodedesc'] = '如果用戶的信用卡不能在因特網上直接獲取，從用戶的銀行獲取手機驗證碼';
$string['anavs'] = '地址驗證系統';
$string['anavsdesc'] = '如果您的 Authorize.Net merchant 帳戶中已激活地址驗證系統，請選擇這項。這會要求用戶在填寫支付表格時填寫地址信息，如街道，州，國家以及郵政編碼等。';
$string['ancaptureday'] = '獲取的日期';
$string['ancapturedaydesc'] = '自動捕獲信用卡，除非老師或管理員審查指定天數之內的訂單。必須啟用CRON。 <br /> （0天，意味著它會禁用預定捕獲，也意味著教師或管理員需要手動審查訂單。如果您禁用了預定捕獲，或這您沒有在30天內審查，那麼交易將被取消。）';
...
$string['anrefererdesc'] = '定義參考的鏈接，如果您已經設置了Authorize.Net商業帳戶。這將在Web請求中發送一行“Referer：URL”。';
$string['anreview'] = '審查';
...
$string['authorize:unenrol'] = '從課程取消用戶選課';
...
$string['pendingechecksubject'] = '點擊鏈接，並且閱讀頁面的幫助文件看到：
{$a->url}
...
$string['reason30'] = '處理器的配置有問題。聯系商業服務的提供者。';
$string['reason39'] = '提供的流通代碼或者是有問題的，不被支持的，不被允許的或者是沒有兌換率';
$string['reason43'] = '在處理器中錯誤的建立了店主。聯系商業服務的提供者。';
...
$string['testwarning'] = '獲取/空的/信用工作在測試模式，但是數據庫中沒有更新記錄';
$string['transid'] = '交易ID';
