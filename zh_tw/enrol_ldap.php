...
$string['assignrole'] = '用戶“{$a->user_username}”在課程“{$a->course_shortname}” (id {$a->course_id})中被分配角色“{$a->role_shortname}”。';
...
$string['cannotcreatecourse'] = '無法創建課程：LDAP記錄中缺少必需的數據！';
...
$string['createcourseextid'] = '創建用戶選的一個不存在的課程“{$a->courseextid}”';
$string['createnotcourseextid'] = '用戶選了一個不存在的課程“{$a->courseextid}”';
$string['creatingcourse'] = '正在創建課程 \'{$a}\'...';
...
$string['explodegroupusertypenotsupported'] = 'ldap_explode_group()不支持選擇的用戶類型：{$a}';
...
$string['group_memberofattribute'] = '說明給定用戶或組屬於哪個組的屬性名（例如：memberOf、groupMembership等）';
...
$string['ldap_encoding'] = '指定LDAP服務器使用的編碼。大多都是utf-8，但MS AD v2使用平台缺省編碼，如cp1252、p1250等。';
...
$string['phpldap_noextension'] = '<em>PHP LDAP模塊貌似不存在。如果您要使用此選課插件，請確認它已經安裝且被激活。</em>';
...
$string['role_mapping'] = '<p>對每一個您想從LDAP分配的角色，您需要指定這些角色的課程組位於哪些場景。用“;”分隔不同的場景。</p><p>您還需要指定您的LDAP服務器使用哪個屬性保存組成員。通常是“member”或“memberUid”</p>';
...
$string['user_contexts'] = '如果組成員包含識別名，指定用戶都位於哪些場景。用“;”分隔不同場景。例如：“ou=users,o=org; ou=others,o=org”';
