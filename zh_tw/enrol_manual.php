...
$string['confirmbulkdeleteenrolment'] = '你確信要刪除該用戶的選課嗎�一';
$string['defaultperiod'] = '缺省保持選課時長';
$string['defaultperiod_desc'] = '選課有效的缺省時間長度（單位秒）。如果此時間設置為零，選課持續時間將會按默認不加以限制�一';
$string['defaultperiod_help'] = '默認的用戶身份有效期長度，從用戶自行加入課程之日算起。禁止此選項意味著默認用戶身份永久有效�一';
...
$string['pluginname_desc'] = '通過人工選課插件，有權限的用戶（例如教師）可以在課程管理設置中的一個鏈接裡手工為其它用戶選課。此插件通常都是啟用的，因為有其它插件（比如自助選課）需要調用它�一';
$string['status'] = '啟用人工選課';
$string['status_desc'] = '允許內部選課的用戶訪問課程。大多數情況都應該啟用這個選項�一';
$string['statusdisabled'] = '已禁用';
$string['statusenabled'] = '已啟用';
$string['status_help'] = '此設置決定用戶是否可以被人工選課。教師等有權限的用戶可以在課程管理設置中的一個鏈接裡人工選擇用戶，加入課程�一';
$string['unenrol'] = '撤銷選課';
...
$string['wsusercannotassign'] = '您在課程({$a->courseid})中沒有權限為用戶({$a->userid})指定這一角色({$a->roleid})�一';
