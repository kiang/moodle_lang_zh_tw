...
$string['customwelcomemessage'] = '自訂歡迎資訊';
$string['defaultrole'] = '預設分配的角色';
$string['defaultrole_desc'] = '選擇使用者自助選課後被分配的角色';
...
$string['enrolstartdate_help'] = '如果啟用，使用者只能在此日期後自行加入此課程。';
$string['groupkey'] = '使用分組選課密碼';
$string['groupkey_desc'] = '預設使用分組選課密碼。';
$string['groupkey_help'] = '除了只限知道密碼的使用者訪問課程以外，還可以讓使用者在選課時輸入分組密碼，這樣他就能被自動加入到小組中。

要使用分組選課密碼，必須在組設置中設定組密碼的同時，在課程設置中設定選課密碼。';
$string['longtimenosee'] = '多久不活動就撤銷選課';
$string['longtimenosee_help'] = '如果使用者很長時間沒有訪問課程，那麼可以自動撤銷他們的選課。此參數決定這個時限。';
$string['maxenrolled'] = '最大選課使用者數';
$string['maxenrolled_help'] = '指定可以自助選課的最大使用者數。0表示無限制。';
$string['maxenrolledreached'] = '已經達到自助選課使用者數上限。';
$string['password'] = '選課密碼';
$string['password_help'] = '只有知道選課密碼的人才能訪問課程。

如果此處留空，那麼任何人都可以隨意選課。

指定選課密碼後，任何想選課的使用者都必須輸入這個密碼。不過，他們只需要輸入一次。';
$string['passwordinvalid'] = '選課密碼錯誤，請重試';
$string['passwordinvalidhint'] = '所輸入的選課密碼不正確, 請重新輸入<br />(提示 - 以{$a}為開頭)';
$string['pluginname'] = '自助選課';
$string['pluginname_desc'] = '通過自助選課外掛，使用者可以自己選擇想參加的課程。可以通過選課密碼保護課程。選課過程是通過人工選課外掛完成得，所以必須在課程中啟用這個外掛。';
$string['requirepassword'] = '必須設選課密碼';
$string['requirepassword_desc'] = '新課程必須設選課密碼，舊課程不能刪除已有的選課密碼。';
$string['role'] = '預設分配的角色';
$string['self:config'] = '配置自助選課實例';
$string['self:manage'] = '管理已選課使用者';
$string['self:unenrol'] = '撤銷已選課使用者';
$string['self:unenrolself'] = '撤銷自己的選課';
$string['sendcoursewelcomemessage'] = '傳送課程的歡迎訊息';
$string['sendcoursewelcomemessage_help'] = '選擇該項，使用者自助選課時會收到一封歡迎郵件。';
$string['showhint'] = '顯示提示';
$string['showhint_desc'] = '顯示訪客密碼的首字母。';
$string['status'] = '允許自助選課';
$string['status_desc'] = '預設允許使用者自己選課。';
$string['status_help'] = '此設置決定使用者是否能自助選課（如果他們有相應的權限，也可以自己撤銷選課）。';
$string['unenrol'] = '撤銷選課';
...
$string['usepasswordpolicy_desc'] = '對選課密碼使用標準的密碼策略。';
