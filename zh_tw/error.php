...
$string['cannotmapfield'] = '發現映射沖突 - 兩個字段映射到相同的成績項 {$a}';
...
$string['cannotservefile'] = '不能傳輸文件——服務器配置錯誤。';
$string['cannotsetparentforcatoritem'] = '無法為類別或課程項設置父類別！';
$string['cannotsetpassword'] = '無法設置用戶密碼！';
...
$string['cannotupdatepasswordonextauth'] = '更新外部認證（{$a}）的密碼失敗。詳見服務器日志。';
...
$string['cannotupdateuseronexauth'] = '更新外部認證（{$a}）的密碼失敗。詳見服務器日志。';
...
$string['csvinvalidcols'] = '<b>無效 CSV 文件：</b>第一行必須是"字段標題"並且該文件須符合<br />"擴展字段/逗號分隔"<br />或<br />"帶CAVV結果代碼的擴展字段/逗號分隔"的類型。';
...
<p>網站管理員還應該檢查config.php文件裡數據庫詳細配置是否正確</p>';
$string['dbdriverproblem'] = '<p>錯誤：檢測出數據庫驅動有問題</p><p>網站管理員應該驗證服務器配置
</p><p>{$a}</p>';
$string['dbsessionbroken'] = '檢測到嚴重的數據庫會話錯誤。<br /><br />請通知服務器管理員。';
$string['dbsessionhandlerproblem'] = '建立數據庫會話失敗。<br /><br />請通知服務器管理員。';
$string['dbsessionmysqlpacketsize'] = '檢測到嚴重的數據庫會話錯誤。<br /><br />請通知服務器管理員。這個問題最可能是由MySQL設置裡的max_allowed_packet值過小引起的.';
...
$string['ddlfieldnotexist'] = '表 "{$a->tablename}"中沒有字段 "{$a->fieldname}" ';
...
$string['errorfetchingrssfeed'] = '獲取RSS種子時出錯。';
$string['erroronline'] = '錯誤發生在第 {$a} 行';
$string['errorparsingxml'] = '解析XML出現錯誤：{$a->errorstring}，發生在行 {$a->errorline}，字符 {$a->errorchar} ';
...
$string['failtoloadblocks'] = '數據庫中注冊了一個或多個版塊，但是加載它們失敗！';
$string['fieldrequired'] = '"{$a}" 是必填的欄位';
$string['fileexists'] = '文件存在';
$string['filemismatch'] = '非核心文件名不匹配。文件"{$a->current}"應為{$a->file}';
...
$string['groupusernotmember'] = '用戶不是這個組的成員。';
...
$string['importformatnotimplement'] = '抱歉，目前不支持導入這種格式.';
$string['incorrectext'] = '文件擴展名不正確';
$string['installproblem'] = '安裝過程中出現的錯誤通常是無法恢復的，如果您要重新安裝，可能需要建立一個新的數據庫或者使用不同的數據庫前綴。';
...
$string['invalidrecord'] = '在數據庫表{$a}中找不到數據記錄。';
$string['invalidrecordunknown'] = '在數據庫中找不到數據記錄。';
...
$string['mimetexnotexecutable'] = '自定義mimetex不可執行！';
...
$string['myisamproblem'] = '數據庫表正在使用MyISAM數據庫引擎，建議使用符合ACID原則的全面支持事務的引擎，比如InnoDB。';
...
<p>網站管理員必須修復此問題。{$a->dbfamily}中表前綴的最大長度為{$a->maxlenght}個字符。</p>';
...
$string['restorechecksumfailed'] = '從您的會話恢復保存的信息時發生了一些錯誤。請檢查你的PHP內存/數據庫包大小限制。恢復停止。';
...
$string['reverseproxyabused'] = '反向代理啟用，不能直接訪問服務器，抱歉。<br />請聯系服務器管理員。';
$string['rpcerror'] = '哎呀！你的MNET通訊失敗！把這條錯誤信息給管理員：{$a}';
...
$string['sessioncookiesdisable'] = '錯誤使用 require_key_login() —— 一定是會話 cookies 被禁用了！';
$string['sessiondiskfull'] = '會話分區已滿。現在不能登錄。<br /><br />請通知服務器管理員。';
...
$string['sessionipnomatch2'] = '抱歉，您此次登錄的IP與上次不同。此安全功能防止他人在您已登錄時竊取您的個人信息。如果您使用無線網絡或者您在不同的網絡中漫游，您可能看見此錯誤。請咨詢站點管理員尋求更多幫助。<br /><br />如果您想繼續，請按F5刷新此頁面。';
...
$string['sslonlyaccess'] = '因為安全原因，只允許https連接，抱歉。';
...
$string['targetdatabasenotempty'] = '目標數據庫不是空的。因為安全原因取消傳輸。';
$string['textconditionsnotallowed'] = '不允許對文本列做條件比較。請在您的查詢中使用sql_compare_text()。';
...
$string['upgraderequires19'] = '錯誤：已在服務器上安裝了新版的Moodle，但是不支持從之前的版本升級。<br />請先升級至最新的1.9.x版。您也可以通過重新安裝原始文件返回之前的版本。';
...
$string['userquotalimit'] = '你已經達到了你的文件配額上限。';
$string['userselectortoomany'] = '盡管多重選擇為false，user_selector仍返回多個已選擇的用戶。';
...
$string['wwwrootmismatch'] = '檢測到錯誤的訪問，該服務器可能只能經由"{$a}"地址訪問，抱歉。<br />請通知服務器管理員。';
