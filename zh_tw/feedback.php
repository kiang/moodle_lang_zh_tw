...
$string['configallowfullanonymous'] = '如果設為“是”，那麼不需要登錄就可以參與反饋活動。這個選項只影響首頁的反饋。';
...
$string['mapcourse_help'] = '默認情況下，在您的主頁創建的反饋表全站可用，並且會在所有使用了反饋版塊的課程中出現。你可以把反饋表設成粘性版塊來強制它出現，或者通過將它映射到指定的課程來限制此反饋表出現的課程。';
...
$string['mapcourses_help'] = '如果您在搜索中選擇了相關的課程，您可以使用映射課程將它們與本反饋關聯。按住Apple或Ctrl鍵點擊課程名，可以選擇多個課程。任何時候都可以取消課程和反饋的關聯。';
...
$string['multiplesubmit_help'] = '如果對匿名調查也啟用，那麼用戶就可以無限次提交反饋。';
$string['name'] = '名稱';
...
$string['url_for_continue_help'] = '提交反饋後，繼續按鈕的目標缺省是課程頁面。您可以在這裡定義另一個目標URL。';
