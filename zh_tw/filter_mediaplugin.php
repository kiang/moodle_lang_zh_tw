...
$string['flashvideo_help'] = '擴展名為*.flv和*.f4v的文件。使用Flowplayer播放視頻，需要Flash外掛和javascript。如果指定了多個源，會使用HTML 5視頻候補方案。';
...
$string['legacyheading_help'] = '下列格式不建議在日常使用。它們通常都用在安裝了由中心管理的客戶端的內部網路。';
...
$string['mp3audio_help'] = '擴展名是*.mp3的文件。使用Flowplayer播放音頻，需要Flash外掛。';
