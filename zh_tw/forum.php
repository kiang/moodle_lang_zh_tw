...
$string['attachment_help'] = '您可以向一個帖子附加一個或多個文件。圖片附件會在正文後顯示�一';
$string['attachmentnopost'] = '您不能導出沒有帖子id的附件';
$string['attachments'] = '附件';
$string['blockafter'] = '執行阻擋的限定篇數';
$string['blockafter_help'] = '此項設置決定用戶在指定的時長內最多允許發幾個帖子。有mod/forum:postwithoutthrottling權限的用戶不受此限�一';
$string['blockperiod'] = '限定的期間';
$string['blockperioddisabled'] = '不要阻擋';
$string['blockperiod_help'] = '學生如果在指定的時長內發了達到指定數量的帖子，會被阻止繼續發帖。有mod/forum:postwithoutthrottling權限的用戶不受此限�一';
...
$string['cannotaddsubscriber'] = '不能向此討論區添加id為{$a}的訂閱人�一';
...
$string['cannotdeleteforummodule'] = '您不能刪除討論區模塊�一';
$string['cannotdeletepost'] = '您不能刪除此帖�一';
$string['cannoteditposts'] = '您不能編輯他人的帖子�一';
...
$string['cannotpurgecachedrss'] = '無法清理目標或源討論區的RSS種子緩存 - 檢查你的文件permissionsforu一';
$string['cannotremovesubscriber'] = '不能從此討論區刪除id為{$a}的訂閱人�一';
$string['cannotreply'] = '您不能回復此帖';
$string['cannotsplit'] = '此討論區的話題不能被分割';
$string['cannotsubscribe'] = '抱歉，您必須是小組成員才能訂閱�一';
...
$string['configmaxattachments'] = '每個帖子缺省允許的最大附件數�一';
...
$string['confirmsubscribe'] = '您確定要訂閱討論區“{$a}”嗎�一';
$string['confirmunsubscribe'] = '您確定要取消訂閱討論區“{$a}”嗎�一';
...
<span style="font-weight: bold;">翻譯者：況亮</span><br style="font-weight: bold;" /><span style="font-weight: bold;">Email：kuangliang12345@163.com</span><br style="font-weight: bold;" /><span style="font-weight: bold;">翻譯日期：2007年3月4日</span><br 一';
...
$string['erroremptysubject'] = '帖子標題不能為空�一';
$string['errorenrolmentrequired'] = '您必須先選修此課才能訪問此內容';
$string['errorwhiledelete'] = '刪除記錄時發生錯誤�一';
...
$string['introblog'] = '本討論區的帖子自動拷貝自課程的博客用戶。那些博客將不能再使用�一';
...
$string['invalidpostid'] = '無效的帖子ID - {$一';
...
$string['maxattachments_help'] = '此項設置決定了一個帖子可以擁有的最大附件數�一';
...
$string['mustprovidediscussionorpost'] = '導出時，您必須提供一個話題id或帖子一';
$string['namenews'] = '公佈欄';
$string['namenews_help'] = '新聞討論區，是一個用來發布消息的特別討論區，在課程建立時會被自動創建。每門課程只能有一個新聞討論區。只有教師和管理員可以在新聞討論區發帖。“最近新聞”版塊會顯示新聞討論區最近的討論�一';
...
$string['subscribeenrolledonly'] = '抱歉，只有已選課用戶才能訂閱討論區帖子通知�一';
...
$string['unsubscribeallconfirm'] = '您目前訂閱了{$a}。您確認要取消所有討論區的訂閱，並禁止自動訂閱嗎�一';
$string['unsubscribealldone'] = '已為您取消所有可選的訂閱，但仍能收到強制訂閱的通知。到“我的個人資料”設置中的消息頁面管理討論區通知�一';
$string['unsubscribeallempty'] = '您沒有訂閱任何討論區。到“我的個人資料”設置中的消息頁面可以設置不接收本站的任何通知�一';
...
$string['warnafter_help'] = '當學生將達到某一時長內允許的最大發帖數時，會被警告。此項設置決定了發多少個帖子後會被警告。有mod/forum:postwithoutthrottling權限的用戶不受此限�一';
