...
$string['attachmentnopost'] = '您不能導出沒有帖子id的附件';
$string['attachments'] = '附件';
$string['blockafter'] = '執行阻擋的限定篇數';
$string['blockafter_help'] = '此項設置決定用戶在指定的時長內最多允許發幾個帖子。有mod/forum:postwithoutthrottling權限的用戶不受此限。';
$string['blockperiod'] = '限定的期間';
$string['blockperioddisabled'] = '不要阻擋';
$string['blockperiod_help'] = '學生如果在指定的時長內發了達到指定數量的帖子，會被阻止繼續發帖。有mod/forum:postwithoutthrottling權限的用戶不受此限。';
$string['blogforum'] = '博客形式的標准討論區';
$string['bynameondate'] = '由{$a->name}發表於{$a->date}';
$string['cannotadd'] = '不能向此討論區添加此話題';
$string['cannotadddiscussion'] = '必須是群組成員才能參與這個討論區';
$string['cannotadddiscussionall'] = '您沒有權限新增討論主題給所有參與者。';
$string['cannotaddsubscriber'] = '不能向此討論區添加id為{$a}的訂閱人！';
$string['cannotaddteacherforumto'] = '不能在課程的第0節添加轉換過的教師討論區';
$string['cannotcreatediscussion'] = '不能建立新話題';
$string['cannotcreateinstanceforteacher'] = '不能建立新的教師討論區模塊實例';
$string['cannotdeleteforummodule'] = '您不能刪除討論區模塊。';
...
$string['cannotpurgecachedrss'] = '無法清理目標或源討論區的RSS種子緩存 - 檢查你的文件permissionsforums';
...
$string['cannotviewusersposts'] = '您能查看的帖子裡沒有此用戶發表的。';
...
$string['configmaxattachments'] = '每個帖子缺省允許的最大附件數。';
...
<p>激活選項後可以選擇開始和結束的日期。</p>

<p>注意：管理員用戶可以看到所有帖子，無論是在開始前還是過期後。</p>
...
$string['exportdiscussion'] = '導出整個話題';
...
$string['forum:exportdiscussion'] = '導出整個話題';
$string['forum:exportownpost'] = '導出自己的帖子';
$string['forum:exportpost'] = '導出帖子';
...
$string['introblog'] = '本討論區的帖子自動拷貝自課程的博客用戶。那些博客將不能再使用。';
...
$string['mustprovidediscussionorpost'] = '導出時，您必須提供一個話題id或帖子id';
$string['namenews'] = '公佈欄';
$string['namenews_help'] = '新聞討論區，是一個用來發布消息的特別討論區，在課程建立時會被自動創建。每門課程只能有一個新聞討論區。只有教師和管理員可以在新聞討論區發帖。“最近新聞”版塊會顯示新聞討論區最近的討論。';
...
$string['notinstalled'] = '討論區模塊沒有被安裝';
...
$string['page-mod-forum-discuss'] = '討論區模塊話題頁';
$string['page-mod-forum-view'] = '討論區模塊主頁';
$string['page-mod-forum-x'] = '任意討論區模塊頁面';
...
$string['subscribeenrolledonly'] = '抱歉，只有已選課用戶才能訂閱討論區帖子通知。';
...
$string['warnafter_help'] = '當學生將達到某一時長內允許的最大發帖數時，會被警告。此項設置決定了發多少個帖子後會被警告。有mod/forum:postwithoutthrottling權限的用戶不受此限。';
