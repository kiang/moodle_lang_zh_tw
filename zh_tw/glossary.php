...
　　
　　<p>教師總是可以對詞條加以評論的。</p>';
$string['allowduplicatedentries'] = '允許重複的項目';
...
$string['cantinsertrel'] = '不能加入類別-項目 關係';
...
$string['cnfallowcomments'] = '在項目處是否允許對辭典進行評論';
$string['cnfallowdupentries'] = '是否允許辭典有重複的項目';
$string['cnfapprovalstatus'] = '設定預設的學生所提交的項目的待審狀態';
$string['cnfcasesensitive'] = '設定項目被連結時，字母大小區分是否如預設值';
...
$string['cnflinkentry'] = '設定項目是否被自動超連結';
...
$string['defaultapproval_help'] = '　　<p align="center"><b>預設審核狀態</b></p>
　　
　　<p>這個選項允許教師設定學生所提交詞條的預設狀態。它可以是自動處於已審核狀態(可以被所有人查閱)，或者需要教師逐一審核。</p>';
...
$string['deleteentry'] = '刪除項目';
$string['deletenotenrolled'] = '由未選課的使用者刪除項目';
$string['deletingcomment'] = '刪除註解';
$string['deletingnoneemptycategory'] = '刪除這個類別將不會一併刪除包含的詞彙，這些內容將被標示成未分類。';
$string['descending'] = '遞減排序';
$string['destination'] = '目的地';
$string['destination_help'] = '　　<p align="center"><b>定義匯入詞條的目標</b></p>
　　
　　<p>您可以指定將詞條匯入到何處：</p>
　　<ul>
　　<li><strong>當前辭彙表：</strong>將匯入的詞條新增到當前開啟的辭彙表之中。</li>
　　<li><strong>新辭彙表：</strong>建立一個新的辭彙表，其資訊取自要匯入的檔，而匯入的詞條會新增到新辭彙表當中。</li>
　　</ul>';
...
$string['displayformatentrylist'] = '項目列表';
...
<dl>
<dt><b>簡單字典</b>:</dt>
<dd>看上去像一部傳統的字典，其中有多個不相干項目。不顯示作者，且附件顯示為一個鏈結。</dd>
...
<dt><b>常見問題</b>:</dt>
<dd>對於顯示一系列常見問題很有用。它自動新增「問題」和「答案」等字樣。</dd>
</dl>
</blockquote>

<hr />
<p>Moodle管理員可以建立新的格式，方法請參考<b>mod/glossary/formats/README.txt</b>中內容。</p>';
...
$string['editentry'] = '編輯項目';
$string['editingcomment'] = '編輯評論';
$string['entbypage'] = '頁顯示的登錄個數';
$string['entries'] = '項目';
$string['entrieswithoutcategory'] = '未分類項目';
$string['entry'] = '項目';
$string['entryalreadyexist'] = '項目已存在';
$string['entryapproved'] = '該項目已通過審核';
$string['entrydeleted'] = '項目被刪除';
$string['entryexported'] = '項目成功匯出';
$string['entryishidden'] = '(該項目目前被隱藏)';
$string['entryleveldefaultsettings'] = '列表預設值';
$string['entrysaved'] = '這項目已經儲存';
$string['entryupdated'] = '這項目已經更新';
$string['entryusedynalink'] = '這項目將被自動連結';
...
<p>如果您不希望某一部分文字(如討論區的貼文)被自動鏈結，則需在文字前後新增<nolink>和</nolink>標記。</p>
<p>若要開啟此功能，整體辭彙表級的自動鏈結選項也必須同時被開啟。</p>
　　';
$string['errcannoteditothers'] = '您無法編輯其他使用者的項目資料';
$string['errconceptalreadyexists'] = '這個概念已經存在，這個辭典不允許重複。';
$string['errdeltimeexpired'] = '您不能刪除它。時限已到！';
$string['erredittimeexpired'] = '這項目的編輯時間已經超過。';
$string['errorparsingxml'] = '解析檔案時發生錯誤，請確認 XML 語法正確。';
$string['explainaddentry'] = '新增項目到目前的辭典。<br> 概念和定義是必填的欄位';
$string['explainall'] = '在一頁中顯示所有項目';
...
$string['explainspecial'] = '顯示沒有由英文字母開頭的項目';
$string['exportedentry'] = '匯出的項目';
$string['exportentries'] = '匯出項目';
$string['exportentriestoxml'] = '匯出項目為XML檔案';
$string['exportfile'] = '將項目匯出到檔案';
$string['exportglossary'] = '匯出辭典';
$string['exporttomainglossary'] = '匯出到主要辭典';
$string['filetoimport'] = '從檔案匯入';
$string['filetoimport_help'] = '　　<p align="center"><b>要匯入的文件</b></p>
　　
　　<p>選擇您自己電腦上的包含著詞條的XML檔，並將其匯入。</p>';
...
　　
　　<p>全域辭彙表與普通的本地辭彙表之間的差別主要在於自動鏈結時全域辭彙表是針對整個網站的(而不僅僅是辭彙表所述的課程)。</p>';
$string['letter'] = '字母';
...
　　
　　<p>注意：對類別名稱的自動鏈結總是大小寫敏感且整詞辨識的。</p>';
$string['linking'] = '自動連結';
...
$string['question'] = '問題';
$string['rejectedentries'] = '已拒絕項目';
$string['rejectionrpt'] = '拒絕項目報告';
$string['resetglossaries'] = '刪除項目由';
$string['resetglossariesall'] = '從所有辭典中刪除項目';
$string['rssarticles'] = 'RSS 中最近文章個數';
$string['rssarticles_help'] = '　　<p align="center"><b>RSS新文章數目</b></p>
　　
　　<p>這個選項允許您設定包含在RSS來源中的文章數目。</p>
　　
　　<p>對於大多數辭彙表來說，5到20之間的數位都是可以的。如果您的辭彙表經常更新，可以增加這個數字。</p>';
$string['rsssubscriberss'] = '顯示概念「{$a}」的RSS匯集';
$string['rsstype'] = '此活動的 RSS 來源';
$string['rsstype_help'] = '<p align="center"><b>辭彙表的RSS來源</b></p>
　　
<p>這個選項允許您啟動辭彙表的RSS來源。</p>
　　
<p>您可以選擇兩種來源：</p>
<ul>
<li><b>有作者資訊：</b>生成的來源會包含每篇文章的作者資訊。</li>
　　
<li><b>無作者資訊：</b>生成的來源不包含每篇文章的作者資訊。</li>
</ul>';
...
　　
　　<p>您可以定制使用者流覽辭彙表的方式。流覽和搜索總是可以是用的，但還可以定義三個額外選項：</p>
　　
...
$string['totalentries'] = '項目總數';
$string['usedynalink'] = '自動連結辭典項目';
$string['usedynalink_help'] = '　　<p align="center"><b>啟動辭彙表的自動鏈結</b></p>
　　
　　<p>啟動這個功能則允許課程中其他部分的內容出現詞條中辭彙的名稱時自動新增指向詞條的鏈結。這包括了論壇的帖子、內部資源、每週總結、心得報告等等。</p>
　　
　　<p>注意啟動辭彙表的自動鏈結功能並不意味著鏈結每個詞條——要使用自動鏈結，還要對每個詞條單獨設置。</p>
　　
　　<p>如果您不希望某一部分文字(如論壇的帖子)被自動鏈結，則需在文字周圍新增&lt;nolink&gt;和&lt;/nolink&gt;標記。</p>
　　
　　<p>注意分類名稱也會自動鏈結。</p>
　　';
