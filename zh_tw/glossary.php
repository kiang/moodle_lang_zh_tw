...
　　
　　<p>教師總是可以使用列印視圖。</p>';
$string['andmorenewentries'] = '還有 {$a} 個新詞條�一';
$string['answer'] = '答案';
$string['approve'] = '核准';
...
$string['completionentries'] = '學生必須創建條目�一';
...
$string['errdeltimeexpired'] = '您不能刪除它。時限已到�一';
...
$string['modulename_help'] = '詞匯模塊能讓使用者創建和維護像字典一樣的定義列表。無論詞名出現在課程的哪裡，都可以被自動鏈接到對應的詞條�一';
...
$string['nopermissiontodelcomment'] = '您不能刪除其他人的評論�一';
$string['nopermissiontodelinglossary'] = '您不能在評論此詞匯表�一';
$string['nopermissiontoviewresult'] = '您只能看您自己的詞條的結果';
$string['notapproved'] = '詞條還未被接受�一';
