...
/**
 * Strings for component 'gradeimport_xml', language 'zh_tw', branch 'MOODLE_23_STABLE'
 *
...
$string['errincorrectuseridnumber'] = '錯誤 - 從檔案匯入的id編號 \'{$a}\'與所有使用者都不符合。';
$string['error'] = '發生錯誤';
$string['fileurl'] = '遠端檔案的URL';
$string['pluginname'] = 'XML檔案';
$string['xml:publish'] = '發佈以XML匯入的所有分數';
$string['xml:view'] = '從XML匯入所有分數';
