...
公式應該開始以等號（=）開頭，並使用常見的數學運運算元，例如max，min和sum。
...
$string['droplow_help'] = '這一設定，讓您能夠指定要有幾個最低分數，從彙整統計中排除。';
$string['dropped'] = '丟棄的';
...
$string['errorupdatinggradeitemaggregationcoef'] = '在更新ID為{$a->id}的成績項的匯總係數（權重或額外加分）時出錯';
$string['excluded'] = '排除';
...
$string['finalgrade_help'] = '如果覆蓋選擇框被勾選，那麼可以直接新增或修正成績。';
$string['fixedstudents'] = '釘住學生欄';
$string['fixedstudents_help'] = '讓學生資訊列靜止，這樣就可以水平滾動成績單，而不會看不到學生資訊列。';
...
$string['gradedisplaytype_help'] = '此設置決定在評分人和使用者報表中如何顯示成績。
...
$string['hiddenasdate_help'] = '如果使用者無法看到隱藏的分數，則顯示提交日期以代替"-"。';
...
$string['hidetotalifhiddenitems_help'] = '此設定指定是否將包含隱藏項目的總分顯示給學生看或以連字元（ - ）取代。
...
$string['importoutcomes_help'] = '可以從csv文件匯入能力。文件格式和能力匯出的csv文件一致。';
...
$string['mode'] = 'Mode';
$string['morethanmax'] = '您所鍵入{$a->username} 的{$a->itemname} 分數高於允許的最高分。';
$string['moveselectedto'] = '移動選出的項目到';
$string['movingelement'] = '搬移{$a}';
$string['multfactor'] = '加權倍數';
$string['multfactor_help'] = '該成績項中的所有分數將被乘以此係數，但不會超過設定的最大值。例如，如果係數設為2，最高分為100，那麼所有低於50的分數會被乘以2，而所有大於等於50的分數會變成100。';
...
$string['outcomeconfirmdelete'] = '您確定您要刪除這核心能力 "{$a}"？';
$string['outcomecreate'] = '新增一新核心能力';
...
$string['overriddennotice'] = '您在這個活動中的最後成績，是經過手動調整的。';
$string['overridesitedefaultgradedisplaytype'] = '覆蓋網站預設值';
$string['overridesitedefaultgradedisplaytype_help'] = '勾選後，課程的分數段和分數範圍可以被自由更改，而不是使用網站的預設設置。';
...
$string['plusfactor_help'] = '平移是一個數字，在應用乘數之後，它被新增到這一計分項目的每一分數上。例如，
X*4+2，這個"2"就是平移。';
$string['points'] = '點數';
...
$string['profilereport'] = '使用者個人報表';
$string['profilereport_help'] = '成績報表被使用在使用者個人資料頁。';
$string['publishing'] = '公佈';
$string['quickfeedback'] = '快速回饋';
$string['quickgrading'] = '快速評分';
$string['quickgrading_help'] = '如果啟用，當開啟編輯功能時，會為每個分數出現一個文字輸入框，讓很多分數可以在同一時間編輯。
...
$string['scaleconfirmdelete'] = '您確定您要刪除這一量尺 "{$a}"？';
$string['scaledpct'] = '量尺 %';
$string['seeallcoursegrades'] = '觀看所有的課程成績';
$string['selectalloroneuser'] = '選擇全部或單一使用者';
$string['selectauser'] = '選擇一使用者';
$string['selectdestination'] = '選擇{$a}的目標';
$string['separator'] = '分隔符號號';
$string['sepcomma'] = '逗號';
$string['septab'] = '標籤';
...
$string['showuseridnumber'] = '顯示使用者學號';
$string['showuseridnumber_help'] = '是否在一個單獨的列中顯示使用者學號。';
$string['showuserimage'] = '顯示使用者個人照片';
$string['showuserimage_help'] = '是否要在評分者報告中的姓名欄位後顯示使用者照片。';
...
$string['user'] = '使用者';
$string['userenrolmentsuspended'] = '使用者被停權(休學)';
$string['usergrade'] = '使用者{$a->fullname} ({$a->useridnumber}) 在試題{$a->gradeidnumber}';
$string['userpreferences'] = '使用者偏好';
