...
$string['compact'] = '精簡';
$string['componentcontrolsvisibility'] = '無論這一計分項目是否隱藏，它仍然受這活動設定所控制。';
...
$string['exportonlyactive'] = '需要正常選課';
...
$string['recovergradesdefault'] = '復原分數預設';
...
$string['showanalysisicon_desc'] = '預設是否要顯示成績分析圖示。

如果這活動模組支援它，這成績分析圖示會鏈接到一個頁面，它對於分數以及分數如何獲得，會有更詳細的解釋。';
...
$string['studentsperpagereduced'] = '降低每一頁最大學生數，從{$a->originalstudentsperpage} 到 {$a->studentsperpage}。

考慮增加PHP的設定max_input_vars from {$a->maxinputvars}。';
