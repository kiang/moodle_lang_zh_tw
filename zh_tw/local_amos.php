...
/**
 * Strings for component 'local_amos', language 'zh_tw', branch 'MOODLE_23_STABLE'
 *
 * @package   local_amos
...
$string['amos:importfile'] = '從上傳的檔案匯入翻譯';
$string['amos:manage'] = 'AMOS管理首頁';
$string['amos:stage'] = '使用AMOS翻譯工具並暫存這些翻譯';
$string['amos:stash'] = '將目前暫存的翻譯儲存到資料庫';
$string['commitbutton'] = '上傳';
$string['commitmessage'] = '上傳訊息';
$string['commitstage'] = '上傳暫存的翻譯';
...
* 拒收 - 語言包維護人已拒收此貢獻，並可能在評論中做瞭解釋
* 接受 - 語言包維護人已經接受此貢獻';
$string['contribstrings'] = '翻譯';
$string['contribstringseq'] = '{$a->orig}個新的';
$string['contribstringsnone'] = '{$a->orig}（語言包中都已經翻譯過了）';
...
$string['contribtimemodified'] = '修改於';
...
$string['importfile'] = '從文件導入已翻譯的字符串';
$string['importfile_help'] = '如果您是離綫翻譯的字符串，可以在這裏把它們放入暫存區。

* 文件必須是合法的Moodle PHP字符串定義文件。Moodle的”/lang/en“目錄下的文件都是例子。
* 文件名必須是字符串所屬的組件的英文名（例如”moodle.php“、”assignment.php“或”enrol_manual.php“）。

文件中所有字符串都會按照所選的版本和語言放入暫存區。';
$string['language'] = '語言';
$string['languages'] = '語言';
$string['log'] = '日誌';
...
* 無色 - 儘管您可以暫存這條翻譯，但是您不可以提交它。您只能將暫存區導出到文件。';
