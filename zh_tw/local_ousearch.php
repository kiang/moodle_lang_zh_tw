...
來自這些 IP 地址的請求可以像任何使用者一樣進行搜索（見摘要文字）。
預設情況下為空白，阻止這種訪問。';
...
$string['toomanyterms'] = '<strong>您已經輸入了太多的搜索條件（詞）。</strong>為了確保搜索結果可以及時顯示，該系統限制最多有 {$a} 個搜索條件。請按「返回」按鈕，並修改您的搜索。';
$string['untitled'] = '(無標題)';
