...
$string['contacts'] = '通訊錄';
$string['context'] = '內容';
$string['couldnotfindpreference'] = '無法加載偏好 {$a}。您傳遞給 message_send() 的 component 和 name 能與 message_providers 中的某行匹配嗎？消息提供者必須出現在數據庫中，這樣用戶才能配置當收到消息時該怎樣被通知。';
$string['defaultmessageoutputs'] = '預設簡訊輸出';
$string['defaults'] = '預設';
$string['deletemessagesdays'] = '多少天前的舊簡訊應當被自動刪除';
$string['disableall'] = '暫時關閉通知';
$string['disableall_help'] = '臨時禁用所有通知，除了被網站管理員設為“強制”的以外';
...
$string['errortranslatingdefault'] = '轉化插件的缺省設置出錯，改為使用系統缺省設置。';
$string['forced'] = '強制的';
