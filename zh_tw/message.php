...
$string['guestnoeditmessage'] = '訪客使用者不能編輯簡訊選項';
$string['guestnoeditmessageother'] = '訪客使用者不能編輯使用者簡訊選項';
$string['includeblockedusers'] = '包括黑名單';
$string['incomingcontacts'] = '新的聯絡人 ({$a})';
$string['keywords'] = '關鍵字';
$string['keywordssearchresults'] = '搜尋結果: 找到{$a}條簡訊';
$string['keywordssearchresultstoomany'] = '找到多於{$a}條簡訊，改進您的搜尋。';
$string['loggedin'] = '線上';
...
$string['messagingdisabled'] = '網站中已停用簡訊功能，將以電子郵件發送來取代。';
...
$string['touserdoesntexist'] = '您不能傳送簡訊給一個不存在的使用者(ID{$a})';
