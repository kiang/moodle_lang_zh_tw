...
$string['configmnet'] = 'MNet支持此服務器與其它服務器或服務之間的通訊。';
...
$string['installreflectionclasserror'] = '源代碼錯誤！MNet 反射器調用類“{$a->class}”的“{$a->method}”方法失敗。原始錯誤信息是：“{$a->error}”';
$string['installreflectionfunctionerror'] = '源代碼錯誤！MNet 反射器調用文件“{$a->file}”中的“{$a->method}”函數失敗。原始錯誤信息是：“{$a->error}”';
...
$string['last_transport_help'] = '上次連接到該主機使用的傳輸方式。';
$string['leavedefault'] = '使用默認的參數代替';
$string['listservices'] = '服務列表';
$string['loginlinkmnetuser'] = '<br/>如果您是 MNet 遠程用戶，可以<a href="{$a}">在這裡確認email地址</a>，您可能重新定向到登錄頁面。<br />';
$string['logs'] = '日誌';
...
$string['mnetidproviderdesc'] = '您可以使用這項功能檢索任意您可以登錄的鏈接網站，如果您能提供正確的郵箱地址來匹配您以前使用過的登錄用戶名。';
$string['mnetidprovidermsg'] = '您應該在 {$a} 登錄。';
$string['mnetidprovidernotfound'] = '很抱歉，沒有找到更多信息';
$string['mnetlog'] = 'Logs';
$string['mnetpeers'] = 'Peers';
$string['mnetservices'] = '服務';
$string['mnet_session_prohibited'] = '宿主服務器中的用戶當前不允許進入到{$a}。';
...
$string['nolocaluser'] = '沒有對應遠程用戶的本地記錄，並且因為此主機不允許自動創建用戶，所以不能建立記錄。請聯系您的系統管理員！';
$string['nomodifyacl'] = '您無權修改MNet訪問控制列表。';
$string['nonmatchingcert'] = '證書主題：<br /><em>{$a->subject}</em><br />和主機中的記錄不匹配：<br /><em>{$a->host}</em>。';
$string['nopubkey'] = '獲取公共密鑰遇到問題。<br />可能是主機不允許MNet訪問或者密鑰是無效的。';
$string['nosite'] = '不能找到站點級別的課程';
$string['nosuchfile'] = '文件/函數 {$a}不存在。';
$string['nosuchfunction'] = '無法找到函數，或者函數禁用RPC。';
...
$string['notBASE64'] = '此字符串不是base64編碼，所以它不可能是有效的密鑰。';
$string['notenoughidpinfo'] = '您的身份提供者沒有提供足夠的信息，不能在本地創建或更新您的賬號。抱歉！';
...
$string['notpermittedtojump'] = '您沒有權限從該Moodle服務器啟動一個遠程會話。';
$string['notpermittedtojumpas'] = '您不能在登錄為其它用戶時啟動遠程會話。';
...
$string['profilefielddesc'] = '在這裡，您可以配置創建或更新賬號時都通過 MNet 發送和接收哪些個人資料字段。您也可以為每個 MNet 伙伴單獨設置這些配置。注意，會永遠發送下面的字段：{$a}';
$string['profilefields'] = '字段簡介';
$string['profileimportfields'] = '導入字段';
$string['promiscuous'] = '混雜的';
$string['publickey'] = '公鑰';
$string['publickey_help'] = '公共密鑰從遠程服務器上直接獲得。';
$string['publickeyrequired'] = '您必須提供一個公鑰。';
$string['publish'] = '公開';
$string['reallydeleteserver'] = '確定刪除服務器嗎？';
$string['receivedwarnings'] = '接收到下面的警告';
$string['recordnoexists'] = '記錄不存在';
$string['reenableserver'] = '否，選擇該選項重新激活服務器。';
$string['registerallhosts'] = '注冊所有主機（混亂模式）';
$string['registerallhostsexplain'] = '您可以選擇自動注冊所有嘗試連接您的主機。這意味著您的主機中將會出現一個記錄列表，其中包含了所有與您互聯，並請求了您的公鑰的MNet網站。<br />您可以在下面的選項為“所有主機”配置服務。通過啟用一些服務，可以為任意遠程網站提供任何服務。';
...
$string['remoteuserinfo'] = '遠程{$a->remotetype}用戶——個人資料取自<a href="{$a->remoteurl}">{$a->remotename}</a>';
...
$string['ssoacldescr'] = '使用此頁面允許/拒絕從遠程MNet主機來訪的指定用戶。當您為遠程用戶提供SSO服務時，這個功能非常有用。為了控制您的<em>本地</em>用戶漫游到其它MNet主機的能力，使用角色系統分配他們<em>mnetlogintoremote</em>權限。';
$string['ssoaclneeds'] = '為了讓這個功能起作用，您必須將網絡打開，並啟用MNet認證插件。';
$string['strict'] = '嚴密的';
$string['subscribe'] = '訂約';
$string['system'] = '系統';
...
$string['usercannotchangepassword'] = '由於您是遠程用戶，所以不能更改密碼。';
$string['userchangepasswordlink'] = '<br /> 您也許可以在<a href="{$a->wwwroot}/login/change_password.php">{$a->description}</a>提供者那裡修改密碼。';
$string['usernotfullysetup'] = '您的賬號不完整。您需要<a href="{$a}">回到您的信息提供者</a>並確定您在那裡的個人資料是完整的。可能需要您重新登錄才能生效。';
$string['usersareonline'] = '警告：當前該服務器有{$a}名用戶登錄到您的網站。';
$string['validated_by'] = '通過網絡驗證： <code>{$a}</code>';
