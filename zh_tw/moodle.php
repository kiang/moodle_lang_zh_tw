...
$string['adminhelphealthcenter'] = '自動監測網站問題';
...
$string['flashupgrademessage'] = '此內容需要Flash外掛才能播放，但是您安裝的版本太舊了。

在升級後，您可能需要註銷，然後再重新登錄。';
$string['folder'] = '資料夾';
...
$string['showonlyweek'] = '只顯示第{$a}周安排';
