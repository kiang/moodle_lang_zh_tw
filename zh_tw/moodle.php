...
/**
 * Strings for component 'moodle', language 'zh_tw', branch 'MOODLE_23_STABLE'
 *
 * @package   moodle
...
$string['action'] = '動作';
$string['actionchoice'] = '您想怎麼處裡文件"{$a}”?';
$string['actions'] = '動作';
$string['active'] = '啟用';
$string['activeusers'] = '啟用者用者';
$string['activities'] = '活動';
$string['activities_help'] = '各種活動，例如討論區、測驗和wiki，使課程獲得各種互動功能';
...
$string['addblock'] = '增加一個區塊';
$string['addcomment'] = '增加一個回應';
$string['addcountertousername'] = '把使用者名稱增加數字來建立使用者';
...
$string['addpagehere'] = '新增頁面到這裡';
$string['addresource'] = '新增線上資源...';
$string['addresourceoractivity'] = '新增一個活動或是資源';
$string['address'] = '地址';
...
$string['backupfromthissite'] = '此站已經備份過了嗎？';
...
$string['backupmissinguserinfoperms'] = '注意：本次備份不包含使用者資料。"測驗"模組和"工作室"模組與此備份不相容，所以他們完全不被備份。';
...
$string['categorycontents'] = '課程子目錄和課程';
...
$string['changesmadereallygoaway'] = '您做出了變更。您確定要離開並放棄所有的變更嗎？';
...
$string['clear'] = '清除';
$string['clickhelpiconformoreinfo'] = '...繼續...點選幫助圖示閱讀全文';
$string['clickhere'] = '按這裡...';
$string['clicktochangeinbrackets'] = '{$a}(點選修改)';
$string['clicktohideshow'] = '點選來展開或折疊';
$string['closewindow'] = '關閉本視窗';
$string['collapseall'] = '全部折疊';
$string['commentincontext'] = '在上下文中尋找此條回應';
$string['comments'] = '回應';
$string['commentsnotenabled'] = '未啟用回應功能';
$string['commentsrequirelogin'] = '登入後才能觀看回應';
...
$string['courseapprovedemail2'] = '您申請的課程，{$a->name}，已經許可。瀏覽您的新課程，請到{$a->url}';
...
$string['coursecompletion'] = '修完課程';
$string['coursecompletions'] = '修完課程';
$string['coursecreators'] = '課程管理員';
$string['coursecreatorsdescription'] = '課程管理員可以建立新課程，並且參與授課或指派教師。';
$string['coursedeleted'] = '已經刪除{$a}課程';
$string['coursedisplay'] = '課程布局';
$string['coursedisplay_help'] = '此刻定決定整個課程是在一頁顯示還是分頁顯示。該設定對某些課程格式沒有影響，如SCORM格式。';
$string['coursedisplay_multi'] = '在每頁顯示一個小傑';
$string['coursedisplay_single'] = '在一頁顯示所有小節';
$string['courseextendednamedisplay'] = '{$a->shortname} {$a->fullname}';
$string['coursefiles'] = '課程檔案';
$string['coursefilesedit'] = '編輯課程文件';
$string['coursefileswarning'] = '課程文件已經被丟棄';
$string['coursefileswarning_help'] = 'Moodle 2.0之，課程文件將不存在。請盡可能使用外部容器。';
$string['courseformatdata'] = '課程格式資料';
$string['courseformats'] = '課程格式';
$string['coursegrades'] = '課程成績';
$string['coursehelpcategory'] = '調整課程在課程列表中的位置可以讓學生更容易發現它。';
$string['coursehelpforce'] = '強制課程中所有活動都使用課程的群組模式。';
$string['coursehelpformat'] = '課程主要頁面會用這裡指定的格式顯示。';
$string['coursehelphiddensections'] = '課程中隱藏的小節如何向學生顯示。';
$string['coursehelpmaximumupload'] = '定義課程中上傳文件的最大長度。會受到全站設定的引響。';
$string['coursehelpnewsitemsnumber'] = '課程主要頁面右邊新聞中顯示最近新聞數目。(設定0表示新聞區塊不會出現)';
$string['coursehelpnumberweeks'] = '課程主要頁面顯示的星期/主題個數';
$string['coursehelpshowgrades'] = '打開成績單的顯示。此設定不會引響每個活動中成績的顯示。';
$string['coursehidden'] = '此課程目前並不對學生開放';
$string['courseinfo'] = '課程資訊';
$string['courselegacyfiles'] = '舊的課程文件';
$string['courselegacyfiles_help'] = '"課程文件"用來與Moodle 1.9及更早的版本相容。存放於此的文件可被課程所有的成員瀏覽，無論您是否加了指向它們的連結。並且您不知道這些文件都被用在Moodle的哪裡。

如果您在這裡儲存課程文件，將會遇到一些關於隱私和安全性的問題。在備份、課程匯入、內容共享或是重新使用時，有可能遇到文件遺失的狀況。因此，建議您不用此儲存區，除非您很清楚您正在做什麼。

下面連結會提供進一步的訊息，並顯示給您一些在Moodle 2中管理文件的更好方法。';
...
$string['courses'] = '課程';
$string['coursesectionsummaries'] = '課程小節敘述';
$string['coursesettings'] = '課程預設設定';
$string['coursesmovedout'] = '將課程由{$a}移出';
$string['coursespending'] = '待審核的開課申請';
$string['coursestart'] = '課程開始';
$string['coursesummary'] = '課程簡介';
$string['coursesummary_help'] = '課程簡介會顯示在課程列表中。搜尋課程時會同時搜尋課程名稱和課程簡介。';
...
$string['deletecategorycheck2'] = '如果刪除此課程類別，您必須選擇該類別下的課程和子類別的處裡方式。';
...
$string['dndenabled'] = '支援拖曳';
$string['dndenabled_help'] = '您可以從桌面拖曳一個或多個要上傳的檔案到下面的框框。<br />注意：這個在其他瀏覽器中可能無法正常運作。';
$string['dndenabled_inbox'] = '您可以經由拖曳檔案到此處來新增檔案';
$string['dndenabled_insentence'] = '支援拖曳';
$string['dnduploadwithoutcontent'] = '沒有上傳任何內容';
$string['dndworkingfile'] = '經過拖曳檔案到課程小節進行上傳';
$string['dndworkingfilelink'] = '經由拖曳檔案或是連結到課程小節進行上傳';
$string['dndworkingfiletext'] = '經由拖曳檔案或文件到課程小節進行上傳';
$string['dndworkingfiletextlink'] = '通過拖曳檔案，文件或是連結到課程小節進行上傳';
$string['dndworkinglink'] = '通過拖曳連結到課程小節進行上傳';
$string['dndworkingtext'] = '經由拖曳文字到課程小節進行上傳';
$string['dndworkingtextlink'] = '經由拖曳文字或是連結到課程小節進行上傳';
...
$string['droptoupload'] = '拖曳檔案到此處進行上傳';
$string['duplicate'] = '複製';
...
$string['editsettings'] = '課程設定';
$string['editsummary'] = '編輯概要';
$string['editthisactivity'] = '編輯本教學活動';
$string['editthiscategory'] = '編輯類別';
$string['edittitle'] = '編輯標題';
$string['edittitleinstructions'] = '按Esc取消，完成請按Enter';
...
$string['emaildisplayhidden'] = '已經隱藏Email';
...
$string['enteremail'] = '輸入您的Email位址';
$string['enteremailaddress'] = '請輸入註冊登記的電子郵件，以便系統重新設定您的密碼，並將新密碼送到您的電子郵件信箱。';
$string['enterusername'] = '輸入您的使用者名稱';
$string['entries'] = '文章';
$string['error'] = '錯誤';
$string['errorcreatingactivity'] = '無法建立活動“{$a}”的實體';
$string['errorfiletoobig'] = '此文件大於{$a}字數的限制';
$string['errornouploadrepo'] = '此網站沒有啟用上傳容器';
...
$string['expirynotifystudents_help'] = '如果指定了選課期間，那麼這項設定會使學生在課程即將停止選課的時候收到Email通知。';
$string['expirythreshold'] = '期滿前幾天提醒';
$string['expirythreshold_help'] = '如果指定了選課期間，那麼這項設定會決定在課程在停止選課之前多少天發出通知。';
$string['explanation'] = '說明';
$string['extendenrol'] = '延長修課期限';
$string['extendperiod'] = '延長修課期限';
$string['failedloginattempts'] = '自從您上次登入後，{$a->attempts}登入失敗';
...
$string['fileuploadwithcontent'] = '不能在文件上傳中包含內容參數';
...
$string['forcepasswordchangecheckfull'] = '您十分確定要將密碼強制改為{$a}嗎？';
$string['forcepasswordchange_help'] = '如果此框被勾選，那麼使用者在下次登入時會被要求修改密碼';
...
$string['format'] = '格式';
$string['format_help'] = '<p align="center"><b>課程格式</b></p>
<p><b>週曆格式</b></p>
<ul>
這種格式是採傳統方式，一週一週地排列，會有一個清楚的起始和結束日期。
每一週包含有幾種學習活動。某些活動，像是"指派作業"可能會有一個"開放期"，比如說兩週，在此之後就無法使用。
</ul>
<p><b>主題格式</b></p>
<ul>
它與週曆格式非常相似，只是它把"週次"稱之為"主題"。一個主題是不受時間限制的，所以您不需要指定任何日期。</ul>
<p><b>社會互動格式</b></p>
<ul>
這個格式是以一個主要論壇(討論區)為主，這社會互動用論壇常出現在主要頁面。它最適合需要彼此自由討論的情境，它們可能不是一個課程，例如，它可以被用來當作系所，或某部門的公告欄。
</ul>';
...
$string['fullname'] = '名稱';
$string['fullnamecourse'] = '名稱';
$string['fullnamecourse_help'] = '課程全名會顯示在課程的頁面頂端和課程列表中。';
$string['fullnamedisplay'] = '{$a->lastname}{$a->firstname}';
$string['fullnameuser'] = '名稱';
...
$string['gpl3'] = '版權所有(C) 1999及以後  Martin Dougiamas  (http://moodle.com)

該系統是自由軟體；您可以按照自由軟體基金會所公布的GNU通用公共許可授權(GPL)進行修改或重新發布；許可授權是以第3版或(由您決定)更新的版本。

散佈該軟體是希望他有用有益，但不提供任何形式的保證，不論是明確還是隱含的，包含但不限於任何可販售和適合特定用途的隱藏保證。

觀看Moodle許可授權頁面了解詳細資訊：http://docs.moodle.org/dev/License';
$string['gpllicense'] = 'GPL授權';
$string['grade'] = '成績';
$string['grades'] = '成績';
$string['gravatarenabled'] = '本站支援<a href="http://www.gravatar.com/">Gravatar</a> 。如果您沒上傳大頭照，Moodle將會試著從您的Gracatar讀取相片。';
$string['group'] = '群組';
...
$string['hiddensections_help'] = '<p align="center"><b>課程中隱藏的段落</b></p>

<p>這一選項允許您決定您課程中隱藏的段落要如何顯示給學生看。</p>

<p>預設中，會顯示一個小區域，(以摺疊的形式，灰色的) 來指出隱長的段落在哪裡。雖然學生無法真正看到隱藏的活動和文字。這在"週曆模式"中特別有用，因為不上課的週次就很清楚了。</p>

<p>若您願意，可以選擇"完全隱藏"，這樣學生甚至不知道這課程中有一些段落被隱藏。</p>';
...
$string['idnumbercoursecategory'] = '分類ID';
$string['idnumbercoursecategory_help'] = '課程分類的ID只用來和外部系統匹配，不會在網站的任何地方顯示。如果此分類也官方編號，可以在此輸入，否則可以留下空白';
...
　　';
$string['idnumbergroup'] = '群組ID編號';
$string['idnumbergrouping'] = '編組ID編號';
$string['idnumbermod'] = 'ID識別號碼';
$string['idnumbermod_help'] = 'ID可以在成績計算公式中唯一標記一個活動．
如果這個活動與任何成績計算公式無關，那麼它的ID號碼可以為空。

ID也可以在成績單中設定，不過只能在活動設定頁面中編輯。';
$string['idnumbertaken'] = '此ID已使用';
...
$string['increasesections'] = '增加小節的數目';
$string['info'] = '資訊';
$string['institution'] = '機構';
$string['instudentview'] = '學生檢視模式';
$string['interests'] = '興趣';
$string['interestslist'] = '興趣列表';
$string['interestslist_help'] = '輸入您的興趣愛好。用半形逗點分隔不同的喜好。您的喜好將會在您的個人資料頁面中顯示為標籤。';
$string['invalidemail'] = '錯誤的電子郵件';
$string['invalidlogin'] = '登入錯誤, 請重試';
$string['invalidusername'] = '使用者名稱只能包含數字、小寫字母、底線( _ )、破折號( - )、小數點 ( . )或(@)';
$string['invalidusernameupload'] = '無效的使用者名稱';
...
$string['legacythemeinuse'] = '您的瀏覽器版本太舊了，所以本站將在相容模式下顯示。';
$string['license'] = '授權';
$string['licenses'] = '授權';
...
$string['maxfilesreached'] = '此項目允許您附加{$a}個檔案';
...
$string['maximumupload_help'] = '<p align="center"><b>課程上傳大小限制</b></p>
<p>這個設定是在界定這一課程中學生上傳檔案的大小限制。它通常先由網站管理員界定(通常為2M)，而且是整個網站通用。</p>
<p>隨後，開設課程的教師可以在每一個活動模組中，再進一步限制上傳檔案的大小。</p>';
$string['maxnumberweeks'] = '星期/主題的最大數量';
$string['maxnumberweeks_desc'] = '此設定控制在課程設定中"星期/主題最大數量"裡面出現的最大課程數量。';
...
$string['messageprovider:courserequestapproved'] = '課程申請核准通知';
$string['messageprovider:courserequested'] = '課程開課請求通知';
$string['messageprovider:courserequestrejected'] = '課程開課被拒絕通知';
...
$string['missingrecaptchachallengefield'] = '缺少reCAPTCHA認證區間';
...
$string['modchooserdisable'] = '活動選擇器關閉';
$string['modchooserenable'] = '活動選擇器打開';
...
$string['myfiles'] = '我的私人檔案';
$string['myfilesmanage'] = '管理我的私人檔案';
$string['myhome'] = '我的首頁';
$string['mymoodledashboard'] = '我的Moodle資訊看板';
$string['myprofile'] = '個人資料';
$string['name'] = '名稱';
$string['nameforlink'] = '您想怎樣命名這個連結？';
$string['nameforpage'] = '您想怎樣命名這個頁面？';
...
$string['newpassword_help'] = '輸入一個新密碼或是留空白來沿用目前密碼。';
...
$string['newsitemsnumber_help'] = '<p align="center"><b>課程新聞條數</b></p>

<p>有一個特殊的討論區稱之為 "新聞"，會出現在"週曆模式"和"主題模式"的課程中。它很適合張貼該讓每個學生看到的注意事項。(預設是每個學生都已訂閱這個討論區，且會經由email收到您的通知。)</p>
<p>這個設定會決定有幾條新聞會出現在您的課程的首頁，新聞就放在(預設是在右手邊)"最新新聞"區塊中。</p>
<p>若您把它設為 "0 新聞項目"，那麼"最新新聞"區塊根本不會出現。</p>';
...
$string['no'] = '否';
$string['noblockstoaddhere'] = '沒有可以加入到此頁的區塊';
$string['nobody'] = '沒人';
$string['nochange'] = '沒有改變';
$string['nocomments'] = '沒有回應';
$string['nocourses'] = '無課程';
...
$string['nohelpforactivityorresource'] = '暫時沒有和此資源或活動相關的支援';
...
$string['orphanedactivities'] = '孤立的活動';
$string['other'] = '其他';
$string['outline'] = '概要';
...
$string['passwordforgotteninstructions2'] = '想重置密碼，請在下面輸入您的使用者名稱或是email位址。如果資料庫中有關於您的紀錄，我們會向您的email位址送出一封信件。信件會解釋如何重新獲得瀏覽權限。';
...
$string['preprocessingbackupfile'] = '預先處裡備份檔案';
$string['preview'] = '預覽';
...
$string['profile'] = '簡介';
$string['profilenotshown'] = '選了至少一門課之後，才能顯示此人的個人描述。';
$string['publicprofile'] = '公開的個人資料';
$string['publicsitefileswarning'] = '注意：任何人都可存取放在此處的檔案';
$string['publicsitefileswarning2'] = '注意：這裡的檔案可以被任何知道(或猜到)網址的人瀏覽，建議將所有備份文件在恢復後立刻刪除。';
$string['publicsitefileswarning3'] = '注意：放在這裡的檔案可以被任何知道(或猜到)網址的人瀏覽。<br/>出於安全考量，備份為間應該只保存到安全的backupdate資料夾。';
$string['publish'] = '發布';
$string['question'] = '試題';
...
$string['resourcedisplaydownload'] = '強制下載';
$string['resourcedisplayembed'] = '嵌入';
$string['resourcedisplayframe'] = '在框架中';
$string['resourcedisplaynew'] = '新視窗';
$string['resourcedisplayopen'] = '開啟';
$string['resourcedisplaypopup'] = '在彈出的新視窗中';
$string['resources'] = '資源';
$string['resources_help'] = '啟用資源類型，幾乎可以把任何類型的web內容加入到課程中';
$string['restore'] = '還原';
$string['restorecancelled'] = '取消還原';
$string['restorecannotassignroles'] = '恢復課程的過程需要分配腳色，但是您沒有對應的權限';
$string['restorecannotcreateorassignroles'] = '恢復課程的過程需要新建或分配角色，但是您沒有對應的權限';
$string['restorecannotcreateuser'] = '恢復過程需要從備份文件建立新使用者\'{$a}\'，但是您沒有相應的權限';
$string['restorecannotoverrideperms'] = '恢復課程的過程需要覆蓋角色，但是您沒有相關的權限';
$string['restorecoursenow'] = '立刻還原這個課程！';
$string['restoredaccount'] = '已恢復帳號';
$string['restoredaccountinfo'] = '此帳號從其他伺服器匯入，密碼已經遺失。要經由email設定新密碼，請點選"繼續"';
$string['restorefinished'] = '還原成功';
$string['restoreto'] = '還原到';
$string['restoretositeadding'] = '警告：您正要回復網站的首頁，加入資料！';
$string['restoretositedeleting'] = '警告：您正要回復網站的首頁，並且會刪除資料！';
$string['restoreuserconflict'] = '從備份檔案還原使用者\'{$a}\'會引起衝突';
$string['restoreuserinfofailed'] = '還原過程已經停止，因為您沒有還原使用者資料的權限。';
...
$string['returntomaincoursepage'] = '會到課程首頁';
$string['returntooriginaluser'] = '返回到{$a}';
$string['revert'] = '重設';
$string['role'] = '角色';
$string['rolemappings'] = '角色對應';
$string['rolerenaming'] = '角色更名';
$string['rolerenaming_help'] = '這項設定允許修改角色在課程中顯示的名稱。只有顯示的名稱可以被修改，角色的權限不會受到影響。新的角色名稱會顯示在課程成員頁面上和課程內的其他地方。如果這個重命名了的腳色已經被網站管理員指定為課程管理者，這個新的腳色名稱也會做為課程列表的一部份顯示出來。';
$string['roles'] = '角色';
$string['rss'] = 'RSS';
...
$string['savecomment'] = '儲存回應';
$string['savedat'] = '儲存在：';
$string['savepreferences'] = '儲存偏好設定';
$string['saveto'] = '儲存到';
$string['scale'] = '量尺';
$string['scale_help'] = '<p align="center"><b>量尺</b></p>

<p>教師可以自行建立新的量尺，用於課程中的任何需要計分的活動。</p>

<p>量尺的名稱應該是能很清出說明其性質的片語:它將會出現在量尺選用清單上，以及跟內容相關連的幫助按鈕上</p>

<p>量尺本身是以價值觀的排列清單來界定，從消極(負面)到積極(正面)排序，並以逗點分開。例如:</p>

<blockquote><i>
   很失望， 不夠好，普通，好，非常好，棒極了!
</i></blockquote>

<p>量尺也應該包括一個好的說明，說明它的意義，以及它應該如何使用。這個說明將會出現在給教師和學生的幫助頁面上。</p>

<p>最後，這裡可能有系統管理事先就界定好的一個或多個"標準"量尺。它們將可以用於所有的課程。</p>';
$string['scales'] = '量尺';
...
$string['scalestandard_help'] = '標準量尺在全站所有的課程中都可用。';
$string['scalestip'] = '使用管理選單上的「量尺」設定，來新增量尺。';
$string['scalestip2'] = '要建立自訂量尺，請點擊課程管理選單裡的"成績"連結，然後選擇編輯、量尺。';
$string['schedule'] = '時程';
$string['screenreaderno'] = '否';
$string['screenreaderuse'] = '畫面朗讀';
$string['screenreaderuse_help'] = '如果設定為是，很多地方（比如聊天）的介面提供更易於使用者瀏覽方式（如視障人士）';
$string['screenreaderyes'] = '是';
$string['screenshot'] = '畫面';
$string['search'] = '搜尋';
$string['searchagain'] = '再次搜尋';
$string['searchbyemail'] = '使用email位址搜尋';
$string['searchbyusername'] = '用使用者名稱搜尋';
$string['searchcourses'] = '搜尋課程';
$string['searchhelp'] = '您可以一次搜尋數個片語，使用+號或-號來表示';
$string['search_help'] = '基本搜尋可以在文字中尋找一個或多個詞。詞之間用空格分隔。只有一個字母的單字會被忽略。

如要進行進階搜尋，直接點選搜尋按鈕，搜尋框中什麼都不要輸入，便可瀏覽進階搜尋表單。';
...
$string['secs'] = '秒';
$string['section'] = '單元';
$string['sectionname'] = '小節名稱';
$string['sections'] = '單元';
$string['sectionusedefaultname'] = '使用預設的小節名稱';
$string['seealsostats'] = '參閱：統計資料';
$string['selctauser'] = '選取一個使用者';
$string['select'] = '選取';
$string['selectacountry'] = '選擇國別';
$string['selectacourse'] = '選取一門課程';
$string['selectacoursesite'] = '選取一個課程或網站';
$string['selectagroup'] = '選取一個小組';
...
$string['showcomments'] = '顯示/隱藏回應';
$string['showcommentsnonjs'] = '顯示回應';
$string['showdescription'] = '在課程頁面中顯示簡介';
$string['showdescription_help'] = '如果啟用，上面的簡介訊息會顯示在課程頁面中，緊連著到活動/資源的連結。';
$string['showgrades'] = '向學生顯示成績';
$string['showgrades_help'] = '<p align="center"><b>課程分數</b></p>

<p>許多活動都允許設定分數</p>
<p>預設中，在課程中的所有分數都可以在分數頁中看到，它在主要課程頁中可找到。</p>
<p>如果教師在某課程中不想打分數，或只是不想讓學生看到分數，那他可以在課程設定中關閉分數的顯示。
   這樣做不會阻止個別活動使用或設定分數，它只是不讓學生看到計分結果而已。</p>';
...
$string['showreports_help'] = '<p align="center"><b>活動報告</b></p>

<p>活動報告可以顯示每位參與者再當前課程中的一切活動，除了列出他們的貢獻之外，這些報告還包括了詳細的使用日誌。</p>

<p>教師可以透過使用每學生的個人資料頁下面的按鈕看到這些活動報告。</p>

<p>學生能否看到自己的活動報告，可以由教師在課程設定中加以控制。就某些課程而言，這些報告是很有用的工具，可以讓學生反省他們在線上學習環境的參與和表現，但就某些課程而言，這可能是沒有必要的。</p>

<p>另一個關掉它的理由是，在產生這些報告的時候，會增加伺服器的負荷。對一個人數多，且授課時間長的班級而言，關掉它會比較有效率。<p>';
$string['showsettings'] = '顯示設定';
$string['showtheselogs'] = '顯示這些紀錄資料';
$string['showthishelpinlanguage'] = '顯示本支援的{$a}版本';
$string['since'] = '開始';
...
$string['sitelegacyfiles'] = '繼承的網站文件';
...
$string['sortby'] = '排序依據';
$string['sortbyx'] = '按{$a}遞增排序';
$string['sortbyxreverse'] = '按{$a}遞減排序';
$string['sourcerole'] = '來源角色';
$string['specifyname'] = '您必須指定一個名稱';
$string['standard'] = '標準的';
$string['starpending'] = '([*] = 待審核的課程)';
$string['startdate'] = '課程開始日期';
$string['startdate_help'] = '<p align="center"><b>課程開始日期</b></p>

<p>這是用來指定這課程的開始時間 (依您當地時區)。</p>

<p>若您的課程是使用"週曆模式"，這將影響每一週的顯示方式，第一週將會由您在此設定的日期開始。</p>

<p>這個設定對於使用"主題模式"和"社會互動模式"的課程沒有影響。</p>

<p>然而有個地方一定被影響的是活動日誌的顯示，它會用這日期作為您可以顯示的最早日期。</p>

<p>一般而言，若您的課程沒有一個真實的開始日期，不設定日期也是很合理的，不管您的課程用的是什麼模式。</p>';
...
$string['success'] = '成功';
$string['summary'] = '摘要';
$string['summary_help'] = '<p align="center"><b>主題/週 的摘要</b></p>

<p>主題摘要的目的是要以簡短文字告知學生這一主題(或週)要做的活動。</p>
...
$string['switchdevicerecommended'] = '切換到建議您設備使用的主題';
...
$string['therearecourses'] = '這裡有 {$a} 堂課程';
$string['thereareno'] = '在此課程沒有 {$a}';
$string['thiscategorycontains'] = '此類別包含';
$string['time'] = '時間';
$string['timezone'] = '時區';
$string['to'] = '到';
$string['tocreatenewaccount'] = '略過直接建立新帳號';
$string['today'] = '今日';
...
$string['uploadnotempdir'] = '沒有臨時資料夾';
...
$string['uploadrenamedcollision'] = '檔案已經重新命名，{$a->oldname}改成{$a->newname}，
因為檔名重複。';
...
$string['userdescription_help'] = '可以在此框中輸入一些關於自己的介紹。它們會在您的個人資料頁中顯示給其他人。';
$string['userdetails'] = '使用者詳細資料';
...
$string['virusfoundlater'] = '您在{$a->course}，於{$a->date}所上傳的{$a->filename}發現含有病毒。這裡是對您檔案所做的處理動作:
{$a->action}

如果這是繳交的作業，您可重新繳交，
您的教師就可以看到。';
$string['virusfoundlateradmin'] = '管理員請注意!在{$a->date}日由{$a->course}課程的使用者{$a->user}上傳的{$a->filename}中，發現含有病毒。以下是對這個檔案的處理報告:
...
$string['windowclosing'] = '本視窗會自動關閉。如果沒有自動關閉，請現在關閉它。';
$string['withchosenfiles'] = '將選定的檔案';
$string['withoutuserdata'] = '不含使用者資料';
$string['withselectedusers'] = '對選擇的使用者...';
$string['withselectedusers_help'] = '*傳送訊息-向一位或多位使用者發送訊息
*增加備註-向一名已選擇的使用者增加備註
*增加通用備註-向多名成員加上相同的備註';
