...
$string['savedconfigfailed'] = '輸入的用戶名/密碼組合不正確，URKUND 已被禁用，請重試。';
$string['savedconfigsuccess'] = '反抄襲設置已保存';
$string['showwhenclosed'] = '當活動關閉';
$string['similarity'] = 'URKUND';
$string['studentdisclosuredefault'] = '所有的文件都將上傳到抄襲檢測服務 URKUND，如果您不希望您的文檔被該站以外的其他機構用作分析材料，您可以在報告生成後使用選擇退出鏈接。';
$string['studentdisclosure_help'] = '該文本將在文件上傳頁面上為所有學生可見。';
...
$string['urkundexplain'] = '若想了解更多關於該插件的信息，請查看：<a href="http://www.urkund.com/int/en/" target="_blank">http://www.urkund.com/int/en/</a>';
...
$string['urkund_show_student_score_help'] = '相似度分值是提交文件中與其他提交內容匹配的百分比。';
$string['urkund_studentemail'] = '向學生發送電子郵件';
$string['urkund_studentemail_help'] = '在文件被處理後會向學生發送一封電子郵件，來通知他們報告已經生成完畢，該郵件也包含了選擇退出鏈接。';
