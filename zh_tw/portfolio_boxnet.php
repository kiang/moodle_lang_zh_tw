...
$string['err_noapikey_help'] = '未為此插件配置 API key。您可以從 OpenBox development 頁面獲取。';
$string['existingfolder'] = '文件放入哪個已有文件夾';
$string['folderclash'] = '您請求創建的文件夾已存在！';
$string['foldercreatefailed'] = '在 box.net 創建您的目標文件夾失敗';
...
$string['setupinfodetails'] = '要獲取 API key，請登錄 Box.net，訪問他們的 <a href="{$a->servicesurl}">OpenBox development page</a>。在“Developer Tools”，跟隨“Create new application”，為您的 Moodle 網站創建新應用。在接下來的表單中，“Redirect URL”字段填入如下網址：<br /><code>{$a->callbackurl}</code><br />您可以自願選擇是否提供關於您的 Moodle 網站的其它信息。將來可以在“View my applications”頁面編輯這些信息。';
$string['sharedfolder'] = '已共享';
$string['sharefile'] = '共享此文件？';
$string['sharefolder'] = '共享此新文件夾？';
$string['targetfolder'] = '目標文件夾';
$string['tobecreated'] = '將創建';
$string['username'] = '您的 box.net 用戶名（不會被保存）';
