...
$string['editingmultianswer'] = '修改內嵌答案(完形填空一';
$string['layout'] = '版面配置';
...
$string['multianswer'] = '內嵌答案(完形填空一';
$string['multianswer_help'] = '內嵌答案(完形填空)題是一段文字，中間可以夾雜多道題目，例如選擇題、填空題�一';
$string['multianswersummary'] = '這種類型的題目非常靈活，但創建題目時必須輸入特殊代碼。可以內嵌的題目包括選擇題、填空題和數字題�一';
