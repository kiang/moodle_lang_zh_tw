...
/**
 * Strings for component 'qtype_multichoice', language 'zh_tw', branch 'MOODLE_23_STABLE'
 *
...
$string['addingmultichoice'] = '新增一道選擇題';
...
$string['errgradesetanswerblank'] = '得分比例設定了，都答案是空白';
$string['feedback'] = '回饋';
...
$string['multichoice_help'] = '從多個選項中做選擇來回答問題，題目中可以包含圖片。有兩種選擇題——單項選擇和多項選擇。';
$string['multichoicesummary'] = '從預先定義的選項中選擇一個或多個做為答案。';
