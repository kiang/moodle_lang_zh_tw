...
$string['addingnumerical'] = '新增一道數字題';
...
$string['numerical_help'] = '從學生角度看，數字題很像填空題。區別是，數字題可以設置可接受的誤差範圍，這樣若干個不同的答案都可被看做是一個答案。例如，如果答案是10，可接受的誤差是2，那麼所有8到12之間的數字都被認為是正確的。';
