...
$string['addingrandomsamatch'] = '添加一道隨機填空匹配題';
...
$string['randomsamatch'] = '隨機填空匹配題';
$string['randomsamatch_help'] = '從學生的角度看，很像匹配題。區別是，名詞和短句（問題）列表是從當前類別的填空題中隨機抽取的。此類別中必須有足夠數量的還未使用的填空題，否則會顯示錯誤信息。';
$string['randomsamatchsummary'] = '很像匹配題，不過是用指定類別中的填空題隨機生成的。';
