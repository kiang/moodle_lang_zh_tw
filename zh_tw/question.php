...
$string['cannotcopybackup'] = '無法復制備份文件';
...
$string['cannotdeletecate'] = '這是本場景的缺省類別，您不能刪除它。';
$string['cannotdeletemissingbehaviour'] = '您不能卸載“丟失的行為”。系統依賴它。';
...
$string['cannotimportformat'] = '抱歉，這種格式的導入功能還未實現！';
...
$string['cannotmovequestion'] = '此腳本不能移動與其它地方的文件有關聯的題目。';
...
$string['check'] = '檢查';
$string['chooseqtypetoadd'] = '選擇要添加哪種類型的題目';
...
$string['defaultmark'] = '缺省分數';
$string['deletebehaviourareyousure'] = '刪除行為{$a}：您確信？';
$string['deletebehaviourareyousuremessage'] = '您將完全刪除題目行為“{$a}”。這會把數據庫中與之有關的所有數據都完全刪除。您確定要繼續嗎？';
$string['deletecoursecategorywithquestions'] = '題庫中有試題與本課程類別關聯，如果繼續，該試題將刪除。你可以先使用題庫界面移走它們。';
...
$string['didnotmatchanyanswer'] = '[與任何答案都不匹配]';
$string['disabled'] = '停用';
$string['disterror'] = '{$a} 分布引發了故障';
$string['donothing'] = '不要複製或移動檔案或改變連結';
$string['editcategories'] = '編輯類別';
$string['editcategories_help'] = '為了不將所有題目都放在一個大列表中，可以創建類別和子類別來管理它們。

每個類別都有一個場景，決定類別中的題目可以在哪裡使用：

* 活動場景 - 題目只在活動模塊中可用
* 課程場景 - 題目在課程中所有活動模塊中可用
* 課程分類場景 - 題目在指定課程類別中的所有課程和活動模塊中可用
...
$string['errorsavingcomment'] = '向數據庫保存試題 {$a->name} 的評價時出錯';
$string['errorsavingflags'] = '保存標記狀態出錯。';
$string['errorupdatingattempt'] = '更新數據庫中的試卷 {$a->id} 時出錯。';
$string['exportcategory'] = '匯出類別';
$string['exportcategory_help'] = '此設置決定導出的題目來自哪個類別。

一些導入格式，例如 GIFT 和 Moodle XML 格式，允許將類別和場景數據包含在導出文件中，這樣在導入時可以重新創建類別（可選）。如果需要此功能，請勾選對應的選擇框。';
$string['exporterror'] = '導出過程發生錯誤！';
$string['exportfilename'] = 'quiz';
$string['exportnameformat'] = '%Y%m%d-%H%M';
$string['exportquestions'] = '導出題目到文件';
...
您可以通過通用反饋提供一些背景給學生，比如此題是考查什麼知識點的；或者通過鏈接告訴他們更多信息，供他們不理解題目時參考。';
...
$string['howquestionsbehave_help'] = '學生可以和此測驗中的題目有多種交互方式。例如，您可能希望學生輸入每道題的答案後再提交整個測驗，然後才評分和顯示反饋。那麼就應該用“延遲反饋”模式。再比如，您可能希望學生在答題過程中每題都提交一下，並獲得立即的反饋；如果他們沒有答對，還有機會再次嘗試，但只能得到較低的分數。那麼就應該用“交互式多次嘗試”模式。';
$string['ignorebroken'] = '忽略已破壞的連結';
$string['importcategory'] = '導入類別';
$string['importcategory_help'] = '此設置決定導入的題目將被歸入哪個類別。

一些導入格式（例如 GIFT 和 Moodle XML 格式）可能會在文件中包含分類和場景數據。如果要利用這些數據，而不是所選的類別，應該勾選相應的選擇框。如果文件指定的類別不存在，將會被自動創建。';
$string['importerror'] = '導入過程中發生錯誤';
$string['importerrorquestion'] = '導入題目出錯';
$string['importfromcoursefiles'] = '... 或選擇一個課程文件來導入。';
$string['importfromupload'] = '選擇上傳的文件…';
$string['importingquestions'] = '從文件中導入 {$a} 道試題';
$string['importparseerror'] = '解析導入文件時發現錯誤。沒能導入任何題目。要導入無錯的題，請重試，並把“遇錯中止”設為“否”';
$string['importquestions'] = '從文件導入題目';
$string['importquestions_help'] = '此功能可以從文本文件導入不同格式的題目。但請注意，文件必須是UTF-8編碼。';
$string['importwrongfiletype'] = '您選定的文件類型（{$a->actualtype}）與此次導入使用的格式（{$a->expectedtype}）不匹配。';
$string['impossiblechar'] = '尋找括號字符時遇到不應該出現的字符 {$a}';
...
$string['manualgradeoutofrange'] = '此成績在有效范圍之外。';
...
$string['marks'] = '得分';
$string['matcherror'] = '成績與成績選項不匹配——此題跳過';
$string['matchgrades'] = '匹配成績';
$string['matchgradeserror'] = '如果不在列表中，出錯';
$string['matchgrades_help'] = '導入的成績必須是此列表的成績之一才有效——100、90、80、75、70、66.666、60、50、40、33.333、30、25、20、16.666、14.2857、12.5、11.111、10、5、0（也包括負值）。如果不是，那麼有兩個選擇：

* 顯示錯誤 - 如果一個題目使用了列表中沒有的分數，那麼將顯示錯誤信息，並且該題目不會被導入
...
$string['movingcategoryandfiles'] = '您確定要移動類別“{$a->name}”和所有子類別至“{$a->contextto}”嗎？<br />已經檢測到{$a->urlcount} 個文件與 {$a->fromareaname}中的題目相鏈接。您想要復制或移動它們到 {$a->toareaname} 嗎？';
$string['movingcategorynofiles'] = '您確定要移動類別“{$a->name}”和所有子類別到“{$a->contextto}”嗎？';
$string['movingquestions'] = '移動試題和所有檔案';
$string['movingquestionsandfiles'] = '您確定要移動題目“{$a->questions}”到<strong>“{$a->tocontext}”</strong>場景嗎？<br />已經檢測到 <strong>{$a->urlcount}個文件</strong>與{$a->fromareaname}中的題目鏈接。您確定要復制或移動它們到{$a->toareaname}嗎？';
$string['movingquestionsnofiles'] = '您確定要移動題目“{$a->questions}”到<strong>“{$a->tocontext}”</strong>嗎？<br />在“{$a->fromareaname}”中<strong>沒有任何文件</strong>鏈接到這些題目。';
...
$string['noquestions'] = '未找到可導出的題。請確認您要導出的類別包含題目。';
...
$string['page-question-export'] = '題目導出頁面';
$string['page-question-import'] = '題目導入頁面';
...
$string['parsingquestions'] = '從導入文件解析題目。';
...
$string['penaltyforeachincorrecttry_help'] = '當您想讓學生可以通過多次答題而獲知正確答案，於是使用“交互式多次嘗試”或“自適應模式”做為題目的行為時，那麼此選項控制錯誤答題罰分多少。

罰分只占題目總分的一定比例。因此，如果題目是3分，罰分是0.3333333，那麼當學生第一次就答對時能獲得3分，第二次才答對能獲得2分，第三次才答對就只能得到1分。';
...
$string['qbehaviourdeletefiles'] = '所有與題目行為“{$a->behaviour}”有關的數據都已從數據庫刪除。要完成刪除（阻止此行為再次自行安裝），您應馬上從服務器刪除這個目錄：{$a->directory}';
$string['qtypedeletefiles'] = '與題目類型“{$a->filter}”有關的所有數據都已從數據庫刪除。為了徹底刪除（並阻止此題目類型自己重新安裝），您現在應該在服務器上刪除此目錄：{$a->directory}';
...
$string['questionbehavioursdisabled'] = '要禁用的題目行為';
$string['questionbehavioursdisabledexplained'] = '輸入您不希望出現在下拉框中的行為，用半角逗號分隔';
$string['questionbehavioursorder'] = '題目行為順序';
$string['questionbehavioursorderexplained'] = '按您希望在下拉菜單看到的順序輸入各個行為，用半角逗號分隔';
$string['questioncategory'] = '試題類別';
$string['questioncatsfor'] = '{$a}的試題類別';
$string['questiondoesnotexist'] = '這題目不存在';
$string['questionidmismatch'] = '題目 id 不匹配';
...
$string['stoponerror_help'] = '此設置決定發生錯誤時，是停止導入（這將導致沒有題目被導入），還是忽略所有有錯的題，導入所有有效的題。';
