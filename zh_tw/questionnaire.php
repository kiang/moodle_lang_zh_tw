...
$string['action'] = '操作';
$string['additionalinfo'] = '附加資訊';
$string['additionalinfo_help'] = '顯示在問卷第一頁頂端的文字。（即，指南，背景資訊，等等。）';
$string['addnewquestion'] = '新增{$a}問題';
$string['addselqtype'] = '新增選中的問題類型';
$string['alignment'] = '對齊單選按鈕';
$string['alignment_help'] = '選擇按鈕對齊類型：垂直對齊（預設）或水平對齊。';
$string['all'] = '所有';
$string['alreadyfilled'] = '您已經完成我們的問卷調查{$a}，謝謝您的參與。';
$string['anonymous'] = '匿名的';
$string['average'] = '平均';
$string['averagerank'] = '平均等級';
$string['bodytext'] = '正文文字';
...
$string['checkboxes'] = '複選框';
$string['checkboxes_help'] = '每行填入一個選項，以供使用者選擇其中一個或多個答案。';
$string['closed'] = '該問卷於{$a}關閉。謝謝。';
$string['closedate'] = '問卷的結束日期';
$string['closedate_help'] = '您可以在此指定問卷關閉的時間。選中該複選框並指定您想要的關閉日期及時間。
在該日期後，使用者將不能填寫問卷。如果該項未被選中，則問卷永遠不會關閉。';
$string['confalts'] = '- 或者 - <br />提交的確認頁面';
$string['confirmdelallresp'] = '您確定要刪除該問卷中的所有回答么？';
$string['confirmdelgroupresp'] = '您確定要刪除{$a}中的所有回答么？';
$string['confirmdelresp'] = '您確定要刪除&nbsp;{$a}&nbsp;的回答嗎？';
$string['confpage'] = '標題文字';
$string['confpagedesc'] = '使用者完成問卷後顯示的「確認」頁面中的標題（粗體）和正文。（如果存在URL，則其顯示URL的內容。）';
$string['confpage_help'] = '使用者完成問卷後顯示的「確認」頁面中的標題（粗體）和正文。（如果存在URL，則其優先於確認文字。）如果您保持此項為空，則在完成問卷時，將會顯示預設資訊（謝謝您完成該問卷）。';
$string['contentoptions'] = '問卷建立方式';
$string['couldnotcreatenewsurvey'] = '不能建立新的調查';
$string['couldnotdelresp'] = '不能刪除回答';
$string['createcontent'] = '定義新內容';
$string['createcontent_help'] = '從單選框中選擇問卷建立方式。預設方式是「建立新的問卷」。';
$string['createnew'] = '建立新的問卷';
$string['crossanalyze'] = '交叉分析';
$string['crosstabulate'] = '交叉製表';
$string['crosstabulation'] = '交叉製表';
$string['date'] = '日期';
...
$string['download'] = '下載';
$string['downloadtextformat'] = '以文字格式下載';
$string['downloadtextformat_help'] = '該特性允許您將問卷中的所有回答保存到文字文件中（CSV）。
該文件可以在以後被匯入到電子表格（例如，MS Excel或Open Office Calc）或者統計軟體中，以進一步處理這些數據。';
$string['dropdown'] = '下拉框';
...
$string['email'] = '電子郵件';
$string['errnewname'] = '抱歉，該名稱已被佔用。請選擇一個新名。';
$string['errorcross'] = '交叉分析錯誤，問題的類型無效。';
$string['erroropening'] = '打開問卷時發生錯誤。';
$string['errortable'] = '系統表錯誤';
$string['essaybox'] = '多行文字框';
$string['essaybox_help'] = '這種問題類型將顯示一個x列 y行的純文字框。

如果x,y的值為0（預設值），Moodle的HTML編輯器會按標準的高度和寬度來顯示。（標準的高度和寬度在 課程/使用者的內容和使用者設置中）';
$string['field'] = '問題{$a}';
$string['fieldlength'] = '輸入框的長度';
$string['fieldlength_help'] = '對於**文字框**問題類型，應設置**輸入框長度**和**最大文字長度**。

預設的輸入框長度為20個字元，最大輸入長度為25個字元。';
...
$string['incorrectmodule'] = '課程模組的ID號錯誤';
...
$string['maxtextlength'] = '文字的最大長度';
$string['minforcedresponses'] = '強制回答的最小數量';
$string['minforcedresponses_help'] = '使用這些參數，強制填寫人必須選擇**最少**和**最多**的選項。如果想強制選擇固定數量的選項，將**最少**和**最多**參數設置為同樣的值。如果只需要最小或者最大值，那就把另一個值空著（預設值**0**）。如果您設置了這些參數（而非預設值**0**），填寫人沒有按要求填寫時，會出現警告。您需要把這些要求通過問卷調查的描述或者問題的文字中向填寫者說明。';
...
$string['num'] = '編號';
$string['numberfloat'] = '您所輸入的數字<strong>{$a->precision}</strong>進行了格式重排或舍入。';
$string['numberofdecimaldigits'] = '小數的位數<strong>{$a->number}</strong>已使用';
$string['numberscaleitems'] = '評分量表的點數';
$string['numberscaleitems_help'] = '評分量表的點數。通常是3到5個點，預設為：**5**。';
$string['numeric'] = '數值型';
$string['numeric_help'] = '如果您希望問卷填寫的是一個標準格式的數字，請使用這種問題類型。';
$string['of'] = '的';
$string['opendate'] = '問卷的開始日期';
$string['opendate_help'] = '您可以在此指定開始問卷調查的時間。選中該複選框並指定您想要的開始日期及時間。在該日期前，使用者不能填寫問卷。如果該項未被選中，則問卷會立即開放。';
$string['option'] = '選項{$a}';
$string['optionalname'] = '問題名稱';
$string['optionalname_help'] = '問題名稱僅用於將回答匯出為CSV/Excel格式時。如果您不需要匯出到CSV，您根本不用考慮問題名稱。如果您計劃經常將問卷的結果匯出為CSV格式，對於問題的命名您有兩個選擇。';
$string['or'] = '-或-';
$string['order_ascending'] = '遞增順序';
$string['order_default'] = '按預設順序查看';
...
在「所有回答」頁面，預設的排序是問卷設計者問題選項的順序。您也可以選擇按遞增或者遞減的順序顯示。';
$string['osgood'] = '奧斯古德語義差異法';
$string['other'] = '其他：';
$string['otherempty'] = '如果您選擇該選項，必須在文字框中輸入些文字！';
...
$string['printblanktooltip'] = '在適於列印的視窗打開空白問卷';
$string['printtooltip'] = '在適於列印的視窗打開當前問卷';
$string['private'] = '私有';
$string['public'] = '公用';
$string['qtype'] = '填寫次數限制';
$string['qtypedaily'] = '只能每天填一次';
$string['qtype_help'] = '設置使用者可填寫問卷的次數：一次，每天一次，每周一次，每月一分或者無次數限制（多次）。';
...
$string['questionnaire:copysurveys'] = '複製模版和私有類問卷';
$string['questionnaire:createpublic'] = '建立公用問卷';
$string['questionnaire:createtemplates'] = '建立模版類問卷';
$string['questionnaire:deleteresponses'] = '刪除所有回答';
$string['questionnaire:downloadresponses'] = '匯出回答為CSV文件';
$string['questionnaire:editquestions'] = '建立並編輯問題';
$string['questionnaire:manage'] = '建立並編輯問卷';
...
$string['respondenteligible_help'] = '設置是否每個人都可以填寫問卷，還是您希望僅由教師或者僅由學生填寫。對於問卷填寫資格選項，可在課程或者活動的級別上進行設置。比如，如果您把調查問卷放在首頁，只想讓教師填寫，那麼您需要讓Moodle知道哪些使用者是教師。';
...
$string['respondenttype_help'] = '設置為「全名」將顯示填寫調查的使用者全名。設置為「匿名」可隱藏使用者的標識。';
$string['response'] = '回答';
...
$string['resume_help'] = '是否允許使用者在提交問卷之前保存他們的回答。這樣使用者可以填寫部分問卷，以後再從保存處恢復填寫。';
$string['resumesurvey'] = '恢復調查問卷';
$string['return'] = '返回';
$string['save'] = '保存';
$string['saveasnew'] = '保存為新問題';
$string['savedprogress'] = '您回答的調查問卷已保存，您可隨時回來繼續填寫問卷。點擊下面{$a}的連結。您可能需要輸入帳號和密碼以便繼續完成問卷。';
...
$string['surveyowner'] = '您必須是問卷的建立者才能進行該項操作';
$string['surveyresponse'] = '調查問卷的回答';
$string['template'] = '模版';
$string['templatenotviewable'] = '問卷的模版不可查看';
$string['text'] = '問題的內容';
$string['textareacolumns'] = '文字區的寬度';
$string['textareacolumns_help'] = '這種問題類型將顯示一個**x列** **y行**的純文字框。如果x,y的值為0(預設值)，Moodle的HTML編輯器會按標準的高度和寬度來顯示。（標準的高度和寬度在 課程/使用者的內容和使用者設置中）';
$string['textarearows'] = '文字框的高度';
$string['textbox'] = '文字框';
$string['textbox_help'] = '對於文字框問題類型，應設置輸入框長度和最大文字長度。預設的輸入框長度為20個字元，最大輸入長度為25個字元。';
$string['textdownloadoptions'] = '文字下載(CSV)的選項';
$string['thank_head'] = '感謝您完成本問卷';
$string['theme'] = '主題';
$string['thismonth'] = '本月';
$string['thisweek'] = '本周';
$string['title'] = '標題';
$string['title_help'] = '問卷的標題，會出現在每頁的頂部。預設的標題就是問卷的名稱，也可修改為您想要的標題。';
$string['today'] = '今天';
$string['total'] = '小計';
$string['type'] = '問題類型';
$string['undefinedquestiontype'] = '未定義的問題類型！';
$string['unknown'] = '未知';
$string['unknownaction'] = '未知的問捲動作...';
$string['url'] = '提交確認頁面的 URL';
$string['url_help'] = '提交問卷之後重定向頁面的URL地址';
$string['usepublic'] = '使用公用問卷';
$string['usetemplate'] = '複製已有的問卷';
$string['vertical'] = '垂直對齊';
$string['view'] = '查看';
$string['viewallresponses'] = '查看所有的回答';
$string['viewallresponses_help'] = '如果問卷調查被設置為 **小組模式**: *可視小組*，或者*分隔小組* 並且當前使用者有訪問所有組的權限，在當前課程中定義了組，那麼使用者可以訪問下拉框中的組。這個下拉框可以讓使用者使用「過濾器」對問卷回答按小組進行分類。如果問卷調查被設置為 **小組模式**: *分隔小組*，那麼沒有訪問所有組權限的使用者(如學生，無權限教師等)只能查看他們所屬小組的回答。';
