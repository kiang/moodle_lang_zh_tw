...
/**
 * Strings for component 'quiz', language 'zh_tw', branch 'MOODLE_23_STABLE'
 *
 * @package   quiz
...
$string['attemptsallowedn'] = '允許答題次數：{$a}';
...
$string['browsersecurity_help'] = '若選擇了"全螢幕彈出式視窗加上一些JavaScript"  <br />
* 只有在學生用的網頁瀏覽器有啟用JavaScript時，這測驗才會開始。<br />
* 這測驗會出現在全螢幕的彈出式視窗，遮蓋了所有其他視窗，且沒有導覽控制。<br />
* 學生盡可能被防止使用複製和貼上功能。<br />';
...
$string['cannotstartgradesmismatch'] = '此測驗還不能參加。它的最高分被設為 {$a->grade}，但是其中所有題目都沒有分數。在「編輯測驗」頁面可以修正此問題。';
...
$string['configmaximumgrade'] = '測驗成績最高分的預設值。';
$string['confignewpageevery'] = '在向測驗新增試題時，會根據您在這裡的設置決定是否自動插入分頁符。';
$string['configpenaltyscheme'] = '在適性模式中，每一錯誤的反應都會被扣分。';
...
$string['decimalplaces_help'] = '　　<p align="center"><b>保留幾位小數</b></p>
　　
　　<p>通過設定這個選項，您可以設定在成績中保留幾位小數。</p>';
...
$string['editingquiz_help'] = '建立測驗的主要思路是：

* 測驗可以在一個或多個頁面中放置題目
* 題庫中保存著所有試題，按類別組織
* 隨機題 - 同一名學生的不同次答題可能得到不同的題目。不同學生也會得到不同的題目';
...
$string['errorunexpectedevent'] = '題目 {$a->questionid} 在試卷 {$a->attemptid} 中發現意外的事件代碼 {$a->event} 。';
$string['essay'] = '申論題';
...
$string['generalfeedback_help'] = '通用反饋是在學生答完題目後，顯示給學生看的文字。
與針對學生的答題情況而給的反饋不同的是，通用反饋總會被顯示。';
$string['grade'] = '分數';
...
$string['history'] = '回答記錄：';
$string['howquestionsbehave_desc'] = '試題在一測驗中的預設動作';
...
$string['import_help'] = '您可以用此功能匯入外部文字文件中的題目。

如果您的文件包含非 ascii 字元，那麼它必須使用 UTF-8 編碼。要特別小心 Microsoft Office 生成的文件，它們常常使用不能被正確處理的特殊編碼。

匯入和匯出格式是外掛式的。其它可選格式在模組和外掛資料庫中可以找到。';
...
$string['inactiveoverridehelp'] = '* 學生不屬於正確的組或角色，不能試此答測驗';
...
$string['invalidattemptid'] = '此試卷ID不存在';
...
$string['invalidoverrideid'] = '無效覆蓋ID';
$string['invalidquestionid'] = '無效題目ID';
$string['invalidquizid'] = '無效測驗ID';
$string['invalidsource'] = '來源視為無效。';
$string['invalidsourcetype'] = '無效的來源型態。';
$string['invalidstateid'] = '無效狀態ID';
$string['lastanswer'] = '您前次答案是';
$string['layout'] = '布局';
$string['layoutasshown'] = '頁面布局如圖所示。';
$string['layoutasshownwithpages'] = '頁面布局如所示。<small>（每 {$a} 道題自動開新頁）</small>';
$string['layoutshuffledandpaged'] = '隨機排列試題，每頁 {$a} 道。';
$string['layoutshuffledsinglepage'] = '隨機排列試題，顯示在同一頁中。';
$string['link'] = '連結';
$string['listitems'] = '列出測驗項目';
$string['literal'] = '逐字';
$string['loadingquestionsfailed'] = '載入試題出錯：{$a}';
...
$string['max'] = '最大';
$string['messageprovider:confirmation'] = '確認您自己上傳的測驗';
$string['messageprovider:submission'] = '測驗提交通知';
$string['min'] = '最小';
$string['minutes'] = '分';
$string['missingcorrectanswer'] = '必須指定正確答案';
$string['missingitemtypename'] = '缺少名稱';
$string['missingquestion'] = '此題目好像不會再存在';
$string['modulename'] = '測驗卷';
$string['modulename_help'] = '教師可以在測驗模組中設計選擇、判斷、辨識等多種類型的題目。所有回答都會被自動評分。教師可以選擇是否給予反饋、是否顯示正確答案。';
$string['modulenameplural'] = '測驗卷';
$string['moveselectedonpage'] = '移動已選定試題到 {$a} 頁';
$string['multichoice'] = '選擇題';
$string['multipleanswers'] = '至少選擇一個答案';
$string['multiplier'] = '多選題';
$string['name'] = '名稱';
$string['navnojswarning'] = '警告：這些連結不會保存您的答案。請使用頁面底端的下一步按鈕。';
$string['neverallononepage'] = '不，所有試題在一個頁面上';
$string['newattemptfail'] = '錯誤：無法在這測驗上開始新的作答';
$string['newpage'] = '新頁面';
$string['newpageevery'] = '自動開始一個新頁面';
...
$string['nogradewarning'] = '此測驗尚未評分，因此您不能根據分數設定反饋。';
$string['nomoreattempts'] = '不可以再作答了';
$string['none'] = '沒有';
$string['noopen'] = '沒有開放日期';
$string['nooverridedata'] = '您必須覆蓋至少一項測驗設置。';
...
$string['noquestionsinfile'] = '匯入文件中沒有試題';
$string['noquestionsinquiz'] = '測驗中沒有題目。';
$string['noquestionsnotinuse'] = '此隨機題未被使用，因為它的類別是空的。';
$string['noquestionsonpage'] = '空白頁';
$string['noresponse'] = '無回覆';
$string['noreview'] = '本試題不允許重新檢視作答結果';
$string['noreviewattempt'] = '您無權回顧此試卷。';
...
$string['notavailable'] = '此測驗現在不可用';
$string['notavailabletostudents'] = '注意：這個測驗未開放給您的學生';
$string['notenoughrandomquestions'] = '類別{$a->category}中沒有足夠的題目用來建立題目{$a->name}（{$a->id}）。';
...
$string['notyetgraded'] = '仍未評分';
$string['notyetviewed'] = '還未看過';
$string['notyourattempt'] = '這不是您的試卷！';
$string['noview'] = '已登錄使用者不允許查看本測驗';
...
$string['onthispage'] = '此頁';
$string['open'] = '未作答';
$string['openclosedatesupdated'] = '已更新測驗開放和關閉的日期';
$string['optional'] = '選項';
$string['orderandpaging'] = '順序與分頁';
$string['orderandpaging_help'] = '每道題目後面的10、20、30這樣的數字表明題目的順序。數字以10為步長遞增，是為了給後新增的題目留空間。要改變題目順序，請修改數字，然後點擊「重新排序試題」按鈕。

要在指定題目後新增分頁符，勾選緊挨題目複選框，再點擊「在所選題目後新增新頁面」按鈕。

要將題目分配在幾個頁面，點擊重新分頁按鈕，然後選擇期望每頁幾道題。';
$string['orderingquiz'] = '順序與分頁';
...
$string['overallfeedback_help'] = '總體反饋是在學生完成測驗之後顯示的文字。如果額外指定了分數邊界（可以是百分比或數字），會根據學生的分數顯示不同的文字。';
$string['overdue'] = '過期';
$string['override'] = '覆蓋';
$string['overridedeletegroupsure'] = '您確定要刪除組 {$a} 的覆蓋？';
$string['overridedeleteusersure'] = '您確定要刪除使用者 {$a} 的覆蓋？';
$string['overridegroup'] = '覆蓋組';
$string['overridegroupeventname'] = '{$a->quiz} - {$a->group}';
$string['overrides'] = '覆蓋';
$string['overrideuser'] = '覆蓋使用者';
...
$string['popupwithjavascriptsupport'] = '全屏幕彈出視窗（JavaScript保障安全）';
...
$string['questionmissing'] = '此會話的題目缺失';
$string['questionname'] = '試題名稱';
$string['questionnonav'] = '<span class="accesshide">題目</span> {$a->number}<span class="accesshide"> {$a->attributes}</span>';
$string['questionnonavinfo'] = '<span class="accesshide">資訊</span> {$a->number}<span class="accesshide"> {$a->attributes}</span>';
$string['questionnotloaded'] = '題目{$a}沒能從資料庫加載';
...
$string['questionsperpageselected'] = '已經設置了每頁題目數，所以分頁現在是固定的，分頁控制被停用。您可以在這裡修改 {$a}。';
$string['questionsperpagex'] = '每頁題目數：{$a}';
$string['questiontext'] = '試題內容';
$string['questiontextisempty'] = '[題干無文字]';
...
$string['quiznotavailable'] = '測驗將開放於：{$a}';
$string['quizopen'] = '開放測驗';
$string['quizopenclose'] = '開啟和關閉日期';
$string['quizopenclose_help'] = '學生只能在開放時間之後答題，並且必須在關閉時間之前結束答題。';
$string['quizopened'] = '這個測驗現在是開放的';
$string['quizopenedon'] = '這個測驗開放於 {$a}';
$string['quizopens'] = '測驗開放';
$string['quizopenwillclose'] = '此測驗正開放，將在 {$a} 關閉';
$string['quizordernotrandom'] = '測驗的順序未被打亂';
$string['quizorderrandom'] = '測驗的順序已經打亂';
$string['quiz:preview'] = '預覽測驗';
$string['quiz:regrade'] = '重新評分測驗嘗試';
...
$string['randomwithsubcat'] = '試題來自這個類別及其子類別。';
...
$string['requirepassword_help'] = '　　<p align="center"><b>需要密碼</b></p>
　　
　　<p>這個欄位是可選的</p>
　　
　　<p>如果您指定了一個密碼，則所有學生必須輸入此一密碼才能參加測驗。</p>';
$string['requirepasswordmessage'] = '知道密碼才能參加此測驗';
$string['requiresafeexambrowser'] = '必須使用 Safe Exam Browser';
...
$string['reviewoptionsheading_help'] = '當使用者回顧試卷或看測驗報告時，這些選項可以控制使用者能看到什麼資訊。

「剛剛答完」的意思是答完題目後的兩分鐘內。「晚一些，但測驗仍然開放」的意思是答完2分鐘後到測驗關閉的這段時間。「測驗關閉後」指的是已經過了測驗關閉時間的時候。如果測驗沒有設定關閉時間，此狀態不會生效。';
$string['reviewresponse'] = '覆閱回應';
$string['reviewresponsetoq'] = '回顧答案（題目：{$a}）';
$string['reviewthisattempt'] = '回顧您此份試卷中的答案';
$string['rqp'] = '遠端試題(RQ)';
$string['rqps'] = '遠端試題(RQ)';
$string['safebrowsererror'] = '此測驗被設置為只能使用 Safe Exam Browser 答題。您不能使用現在的瀏覽器答題。';
$string['safebrowsernotice'] = '此測驗被設置為只允許學生使用 Safe Exam Browser 答題。';
...
$string['subnetwrong'] = '此測驗只能從特定位置訪問，而此計算機不在允許之列。';
...
$string['upgradesure'] = '<div style="color: red;">測驗模組將執行測驗資料表的重大變更，此更新尚未有足夠的測試。在處理過程進行前，您需緊急備份您的資料庫資料表。';
...
$string['youcannotwait'] = '在您可以再次答題之前，此測驗就已經關閉了。';
$string['youmustwait'] = '在再次答題之前您必須等待。{$a}之後您才可以再次答題。';
