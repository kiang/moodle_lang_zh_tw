...
$string['adaptive_help'] = '如果啟用，在本測驗的一次答題中，可以多次回答同一道題。例如，如果一次回答被評為錯誤，學生可以馬上再次嘗試。不過，如果“使用罰分”設置開啟，那麼每次錯誤的嘗試都會導致丟分�一';
$string['addaquestion'] = '增加一試題';
$string['addarandomquestion'] = '增加一隨機試題';
$string['addarandomquestion_help'] = '添加隨機題後，會從類別中隨機選出一道題，插入到測驗中。也就是說，不同學生會得到不同的題。如果測驗允許多次答題，那麼每次答題都會看到不同的題�一';
...
$string['attemptsallowedn'] = '允許答題次數：{$一';
...
$string['cannotstartgradesmismatch'] = '此測驗還不能參加。它的最高分被設為 {$a->grade}，但是其中所有題目都沒有分數。在“編輯測驗”頁面可以修正此問題�一';
...
$string['configdelay1'] = '如果您設置了一個時延，那麼學生在第一次答題之後必須等待這段時間�一';
...
$string['configintro'] = '這裡設置的值是您創建新測驗時設置表單中的缺省值。您還可以配置哪些測驗設置是高級設置�一';
$string['configmaximumgrade'] = '測驗成績最高分的缺省值�一';
$string['confignewpageevery'] = '在向測驗添加試題時，會根據您在這裡的設置決定是否自動插入分頁符�一';
...
$string['editingquiz_help'] = '創建測驗的主要思路是：
...
$string['errorunexpectedevent'] = '題目 {$a->questionid} 在試卷 {$a->attemptid} 中發現意外的事件代碼 {$a->event} �一';
$string['essay'] = '申論題';
...
$string['generalfeedback_help'] = '通用反饋是在學生答完題目後，顯示給學生看的文本。
與針對學生的答題情況而給的反饋不同的是，通用反饋總會被顯示�一';
$string['grade'] = '分數';
...
$string['import_help'] = '您可以用此功能導入外部文本文件中的題目。

如果您的文件包含非 ascii 字符，那麼它必須使用 UTF-8 編碼。要特別小心 Microsoft Office 生成的文件，它們常常使用不能被正確處理的特殊編碼。

導入和導出格式是插件式的。其它可選格式在模塊和插件數據庫中可以找到�一';
...
$string['invalidoverrideid'] = '無效覆蓋一';
$string['invalidquestionid'] = '無效題目一';
$string['invalidquizid'] = '無效測驗一';
$string['invalidsource'] = '來源視為無效。';
$string['invalidsourcetype'] = '無效的來源型態。';
$string['invalidstateid'] = '無效狀態一';
$string['lastanswer'] = '您前次答案是';
$string['layout'] = '布局';
$string['layoutasshown'] = '頁面布局如圖所示�一';
$string['layoutasshownwithpages'] = '頁面布局如所示。<small>（每 {$a} 道題自動開新頁）</smal一';
$string['layoutshuffledandpaged'] = '隨機排列試題，每頁 {$a} 道�一';
$string['layoutshuffledsinglepage'] = '隨機排列試題，顯示在同一頁中�一';
$string['link'] = '連結';
$string['listitems'] = '列出測驗項目';
$string['literal'] = '逐字';
$string['loadingquestionsfailed'] = '載入試題出錯：{$一';
...
$string['modulename_help'] = '教師可以在測驗模塊中設計選擇、判斷、匹配等多種類型的題目。所有回答都會被自動評分。教師可以選擇是否給予反饋、是否顯示正確答案�一';
...
$string['name'] = '名稱';
$string['navnojswarning'] = '警告：這些鏈接不會保存你的答案。請使用頁面底端的下一步按鈕�一';
...
$string['nodatasubmitted'] = '沒有被上傳的數據�一';
$string['noessayquestionsfound'] = '找不到人工評分的題目';
$string['nogradewarning'] = '此測驗尚未評分，因此您不能根據分數設定反饋�一';
$string['nomoreattempts'] = '不可以再作答了';
$string['none'] = '沒有';
$string['noopen'] = '沒有開放日期';
$string['nooverridedata'] = '您必須覆蓋至少一項測驗設置�一';
...
$string['noquestionsinfile'] = '導入文件中沒有試題';
$string['noquestionsinquiz'] = '測驗中沒有題目�一';
$string['noquestionsnotinuse'] = '此隨機題未被使用，因為它的類別是空的�一';
$string['noquestionsonpage'] = '空白頁';
$string['noresponse'] = '無回覆';
$string['noreview'] = '本試題不允許重新檢視作答結果';
$string['noreviewattempt'] = '您無權回顧此試卷�一';
$string['noreviewshort'] = '不允許';
$string['noreviewuntil'] = '本試題 {$a}　以後才可以檢視作答結果';
$string['noreviewuntilshort'] = '可用 {$一';
$string['noscript'] = 'JavaScript 必須要啟動才能繼續!';
$string['notavailable'] = '此測驗現在不可用';
$string['notavailabletostudents'] = '注意：這個測驗未開放給您的學生';
$string['notenoughrandomquestions'] = '類別{$a->category}中沒有足夠的題目用來創建題目{$a->name}（{$a->id}）�一';
...
$string['notyourattempt'] = '這不是您的試卷�一';
$string['noview'] = '已登錄用戶不允許查看本測驗';
...
$string['orderandpaging_help'] = '每道題目後面的10、20、30這樣的數字表明題目的順序。數字以10為步長遞增，是為了給後添加的題目留空間。要改變題目順序，請修改數字，然後點擊“重新排序試題”按鈕。

要在指定題目後添加分頁符，勾選緊挨題目復選框，再點擊“在所選題目後添加新頁面”按鈕。

要將題目分配在幾個頁面，點擊重新分頁按鈕，然後選擇期望每頁幾道題�一';
...
$string['overallfeedback_help'] = '總體反饋是在學生完成測驗之後顯示的文本。如果額外指定了分數邊界（可以是百分比或數字），會根據學生的分數顯示不同的文本�一';
$string['overdue'] = '過期';
$string['override'] = '覆蓋';
$string['overridedeletegroupsure'] = '您確定要刪除組 {$a} 的覆蓋�一';
$string['overridedeleteusersure'] = '您確定要刪除用戶 {$a} 的覆蓋�一';
$string['overridegroup'] = '覆蓋組';
$string['overridegroupeventname'] = '{$a->quiz} - {$a->grou一';
$string['overrides'] = '覆蓋';
...
$string['popupwithjavascriptsupport'] = '全屏幕彈出窗口（JavaScript保障安全�一';
...
$string['questionnonav'] = '<span class="accesshide">題目</span> {$a->number}<span class="accesshide"> {$a->attributes}</spa一';
$string['questionnonavinfo'] = '<span class="accesshide">信息</span> {$a->number}<span class="accesshide"> {$a->attributes}</spa一';
$string['questionnotloaded'] = '題目{$a}沒能從數據庫加載';
...
$string['questionsperpageselected'] = '已經設置了每頁題目數，所以分頁現在是固定的，分頁控制被禁用。您可以在這裡修改 {$a}�一';
$string['questionsperpagex'] = '每頁題目數：{$一';
$string['questiontext'] = '試題內容';
$string['questiontextisempty'] = '[題干無文字一';
...
$string['quiznotavailable'] = '測驗將開放於：{$一';
$string['quizopen'] = '開放測驗';
$string['quizopenclose'] = '開啟和關閉日期';
$string['quizopenclose_help'] = '學生只能在開放時間之後答題，並且必須在關閉時間之前結束答題�一';
$string['quizopened'] = '這個測驗現在是開放的';
$string['quizopenedon'] = '這個測驗開放於 {$一';
...
$string['randomwithsubcat'] = '試題來自這個類別及其子類別�一';
...
$string['reportnotfound'] = '未知的報告 ({$a一';
...
$string['requiresafeexambrowser'] = '必須使用 Safe Exam Brows一';
...
$string['reviewoptionsheading_help'] = '當用戶回顧試卷或看測驗報告時，這些選項可以控制用戶能看到什麼信息。

“剛剛答完”的意思是答完題目後的兩分鍾內。“晚一些，但測驗仍然開放”的意思是答完2分鍾後到測驗關閉的這段時間。“測驗關閉後”指的是已經過了測驗關閉時間的時候。如果測驗沒有設定關閉時間，此狀態不會生效�一';
$string['reviewresponse'] = '覆閱回應';
$string['reviewresponsetoq'] = '回顧答案（題目：{$a}�一';
$string['reviewthisattempt'] = '回顧您此份試卷中的答案';
$string['rqp'] = '遠端試題(RQ)';
$string['rqps'] = '遠端試題(RQ)';
$string['safebrowsererror'] = '此測驗被設置為只能使用 Safe Exam Browser 答題。您不能使用現在的瀏覽器答題�一';
$string['safebrowsernotice'] = '此測驗被設置為只允許學生使用 Safe Exam Browser 答題�一';
...
$string['subnetwrong'] = '此測驗只能從特定位置訪問，而此計算機不在允許之列�一';
...
$string['youcannotwait'] = '在您可以再次答題之前，此測驗就已經關閉了�一';
$string['youmustwait'] = '在再次答題之前您必須等待。{$a}之後您才可以再次答題�一';
