...
$string['confirmcheckin'] = '即將把修改過的字符串保存到您本地語言包中。這將從翻譯器導出自定義的字符串到數據目錄中，然後Moodle會開始使用這些修改過的字符串。按“繼續”按鈕開始保存�一';
...
$string['markinguptodate_help'] = '如果在您自定義字符串後，原始的英文或主翻譯有修改，那麼自定義的翻譯就過期了。請重新審查此自定義翻譯。如果您認為它是最新的，就點此復選框。否則，就編輯它�一';
$string['markuptodate'] = '標記為最新';
$string['modifiedno'] = '沒有需要保存的已改動字符串�一';
$string['modifiednum'] = '有 {$a} 條修改過的字符串。您想把它們保存到您本地的語言包嗎�一';
