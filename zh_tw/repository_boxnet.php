...
/**
 * Strings for component 'repository_boxnet', language 'zh_tw', branch 'MOODLE_23_STABLE'
 *
...
$string['shareurl'] = '共享連結';
$string['username'] = 'Box.net的帳號';
