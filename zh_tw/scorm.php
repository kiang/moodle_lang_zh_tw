...
$string['advanced'] = '進階';
$string['allowapidebug'] = '啟用 API 調試與跟蹤（用 apidebugmask 設置捕獲掩碼）';
$string['allowtypeexternal'] = '啟用外部包類型';
$string['allowtypeimsrepository'] = '啟用 IMS 包類型';
$string['allowtypelocalsync'] = '啟用可下載包類型';
$string['apidebugmask'] = 'API 調試捕獲掩碼——對 &lt;username&gt;:&lt;activityname&gt; 使用簡單的正則表達式。例如：admin:.* 會只調試管理員使用者';
...
$string['autocontinuedesc'] = '此選項設置活動預設情況下是否會自動繼續';
...
$string['forcecompleted'] = '強製為完成';
$string['forcecompleteddesc'] = '該參數設置強制完成的預設值';
$string['forcecompleted_help'] = '如果打開，當前訪問的狀態會強制變為「完全的」。該項設置僅適用於SCORM1.2課件包。如果SCORM包在查看惑或瀏覽模式不能正確處理再次訪問，或者不能正確處理完成狀態時，非常有用。';
$string['forcejavascript'] = '強制使用者打開JavaScript';
$string['forcejavascript_desc'] = '如果設置為打開（推薦），在使用者瀏覽器不支持或者關閉JavaScript時，拒絕對SCORM內容的訪問。如果設置為標上，使用者仍可以查看SCORM的內容，但是API不能通訊，SCORM課件成績等資訊不能保存到系統中。';
$string['forcejavascriptmessage'] = '需要Javascript支持，請您打開瀏覽器中的JavaScript設置，然後再試一次。';
$string['forcenewattempt'] = '強製為新嘗試';
$string['forcenewattemptdesc'] = '該參數設置強製為新嘗試的預設值';
...
$string['grademethoddesc'] = '活動的預設評分方法';
...
$string['hidebrowsedesc'] = '活動預設是否允許預覽模式';
...
$string['hidetocdesc'] = '在 SCORM 播放器中預設顯示還是隱藏課程結構（目錄）';
...
$string['lastattemptlockdesc'] = '該參數設置在最後一次嘗試後鎖定的預設值';
$string['lastattemptlock_help'] = '如果打開，學生用完了分配給他們的嘗試次數，學生將不能再打開SCORM播放器';
$string['location'] = '顯示位址列';
$string['max'] = '最高分';
$string['maximumattempts'] = '使用次數';
$string['maximumattemptsdesc'] = '活動預設的學習次數';
$string['maximumattempts_help'] = '這裡定義了允許使用者嘗試的次數。該設置僅支持SCORM1.2和AICC的課件包。';
$string['maximumgradedesc'] = '活動預設的最高分';
...
$string['modulename_help'] = 'SCORM和AICC是一套基於Web學習內容的規範，具有互用性、輔助性和復用性。通過SCORM/AICC模組可將SCORM/AICC課件包加入到課程中。';
...
$string['optallstudents'] = '全部使用者';
$string['optattemptsonly'] = '學習過的使用者';
$string['options'] = '選項';
$string['optnoattemptsonly'] = '未學習過的使用者';
...
$string['page-mod-scorm-x'] = '任意 SCORM 模組頁面';
...
$string['popupsblocked'] = '彈出式視窗被阻攔了，使 scorm 模組不能播放。請檢查您的瀏覽器設置，然後再開始。';
...
$string['report'] = '結果';
$string['reportcountallattempts'] = '{$a->nbusers} 名使用者的 {$a->nbattempts} 次學習，共 {$a->nbresults} 個結果';
$string['reportcountattempts'] = '{$a->nbresults} 個結果（{$a->nbusers} 名使用者）';
...
$string['scormopen'] = '開放';
$string['scormresponsedeleted'] = '刪除使用者學習記錄';
...
$string['skipviewdesc'] = '預設何時會跳過內容結構頁面';
...
$string['stagesize_help'] = '這兩個設置用來限定學習對象的框架/視窗的高度和寬度。';
$string['started'] = '開始';
$string['status'] = '狀態';
...
$string['updatefreqdesc'] = '預設的自動更新頻率';
...
$string['viewalluserreports'] = '檢視{$a}位使用者的報告';
$string['whatgrade'] = '使用評分';
$string['whatgradedesc'] = '預設的多次學習評分策略';
$string['whatgrade_help'] = '如果允許多次答題，那麼此設置決定是將最高分、平均分、第一次得分還是最後一次完成的得分記入成績單。

對多次答題的處理

* 開始新試答的選項是一個複選框，它在內容結構頁的進入按鈕上面。因此，如果您想允許多次答題的話，一定要允許使用者訪問此頁。
...
$string['width'] = '寬度';
$string['window'] = '視窗';
$string['zlibwarning'] = '警告：此網站啟用了 PHP Zlib 壓縮。在某些瀏覽器中，使用者打開 SCORM 對象時可能會遇到問題。';
