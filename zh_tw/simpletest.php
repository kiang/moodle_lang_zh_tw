...
$string['codecoveragedisabled'] = '不能在此服務器做代碼覆蓋測試（缺少xdebug擴展）。';
...
$string['prefixnotset'] = '未配置單元測試數據庫表前綴。填寫並提交此表單，把它添加到config.php中。';
...
$string['testtablesneedupgrade'] = '測試數據庫表需要升級。您想現在就升級嗎？';
$string['testtablesok'] = '測試數據庫表已成功安裝。';
