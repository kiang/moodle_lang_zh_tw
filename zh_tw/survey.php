...
$string['cannotfindanswer'] = '此調查還沒有答卷。';
$string['cannotfindquestion'] = '該問題不存在';
$string['cannotfindsurveytmpt'] = '還沒有調查模板！';
...
$string['invalidtmptid'] = '無效的模板 id';
$string['ipreferthat'] = '我希望的是';
$string['modulename'] = '問卷';
$string['modulename_help'] = '調查模組提供三種調查問卷，來評估和鼓勵在線環境下的學習。教師可以用它們來收集數據，幫助他們了解課程情況，改進自己的教學。';
...
$string['page-mod-survey-x'] = '任意調查模組頁面';
...
* 思考與學習態度調查（ATTLS）- 用來度量個體是「連結型學習者」（願意尋找學習的樂趣，樂於合作和接受他人意見）還是「分隔型學習者」（對學習採用更批評和思辨的立場）
* 關鍵事件調查
* 建構式在線學習環境調查（COLLES）- 了解網際網路的哪種交互能力更能促進學生實踐動態學習';
