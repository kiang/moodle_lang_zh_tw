...
/**
 * Strings for component 'theme_arialist', language 'zh_tw', branch 'MOODLE_23_STABLE'
 *
...
$string['choosereadme'] = '<div class="clearfix">
	...
	<div class="theme_description">
		...
		<h2>關於</h2>
		<p>詠嘆是一個非常簡潔、雙列、可變寬的 Moodle 2.0 主題</p>

		<h2>調整</h2>
		<p>本主題基於 Moodle 核心的基本主題和畫布主題構建。如果您想修改它，我們建議您在修改之前先複製一份並換名。這樣將來 Moodle升 級時才不會覆蓋您定製的主題。而且一旦您搞亂了它，還有原始文件的備份。關於修改主題的更多資訊請瀏覽<a href="http://docs.moodle.org/en/Theme">Moodle文檔</a>。</p>

	<h2>致謝</h2>
	<p>本主題由 NewSchool Learning 的 Patrick Malley 編寫和維護。可以通過 contact@newschoollearning.com 聯繫他。</p>

		<h2>授權</h2>
		<p>Moodle 核心提供的所有主題，包括此主題的授權協議都是 <a href="http://www.gnu.org/licenses/gpl.html">GNU General Public License</a>。
	</div>
</div>';
$string['configtitle'] = '詠嘆設置';
