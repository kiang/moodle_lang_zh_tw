...
/**
 * Strings for component 'theme_nimble', language 'zh_tw', branch 'MOODLE_23_STABLE'
 *
...
$string['choosereadme'] = '<div class="clearfix">
	...
	<div class="theme_description">
		...
		<h2>關於</h2>
		<p>靈動是一個雙列、可變寬的Moodle 2.0主題。它支持在每頁網站標題上方顯示自定義菜單。它還有一個基本的設置頁面，可以修改鏈接顏色，在首頁站名上添加標語，和添加底腳文本。</p>

		<h2>父主題</h2>
		<p>本主題基於Moodle核心的基本主題和畫布主題構建。如果除了設置裡提供的定制功能以外，您還想做其它修改，我們建議您創建一個新主題，並將本主題、基礎和畫布做為父主題。這樣這三個核心主題中任意一個的更新都能反映到您的主題上。</p>

		<h2>致謝</h2>
		<p>本主題由Patrick Malley (patrick@newschoollearning.com)設計，John Stabinger (john@newschoollearning.com)提供了幫助。
		<h2>授權</h2>
