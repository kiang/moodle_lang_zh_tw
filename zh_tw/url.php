...
$string['clicktoopen'] = '點擊{$a}連結打開資源。';
...
$string['configsecretphrase'] = '此秘密短語被用來生成加密的代碼。此代碼可以當做參數發送給某些伺服器。加密的代碼是當前使用者的IP地址和您的秘密短語的md5值。即，code = md5(IP.秘密短語)。請注意，因為IP地址會變化，且經常在不同計算機之間共享，所以並不可靠。';
...
* 強制下載 - 使用者會被提示下載此文件
* 打開 - 只在瀏覽器視窗中顯示此文件
* 在彈出視窗中 - 在一個無菜單和地址欄的新視窗中顯示文件
* 在框架中 - 在導航欄和文件描述下方的框架里顯示文件
* 新視窗 - 在有菜單和地址欄的新視窗中顯示文件
';
...
$string['page-mod-url-x'] = '任意URL模組頁面';
$string['parameterinfo'] = '&amp;參數=變量';
$string['parametersheader'] = '參數';
$string['parametersheader_help'] = '可以將一些Moodle內部變量自動附加到URL上。在每個文字框中輸入參數名，然後選擇配套的變量。';
$string['pluginadministration'] = 'URL模組管理';
$string['pluginname'] = 'URL';
$string['popupheight'] = '彈出視窗高度（單位：像素）';
$string['popupheightexplain'] = '指定彈出視窗的預設高度。';
$string['popupwidth'] = '彈出視窗寬度（單位：像素）';
