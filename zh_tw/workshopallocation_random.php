...
$string['addselfassessment'] = '新增自我評價';
...
$string['confignumofreviews'] = '預設隨機分配作業的個數';
$string['excludesamegroup'] = '防止在同一組的同學互相評價';
$string['noallocationtoadd'] = '不需新增分配';
$string['nogroupusers'] = '<p>警告：如果互動評價處在「可視小組」模式或者「分隔小組」模式，那麼使用者必須至少屬於一個組，才能用此工具向他們分配評價任務。不屬於任何組的使用者仍然可以做自我評價或者刪除已有的評價。</p> <p>這些使用者目前還未被加入任何組：{$a}</p>';
