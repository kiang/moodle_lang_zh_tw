...
/**
 * Strings for component 'workshopform_numerrors', language 'zh_tw', branch 'MOODLE_23_STABLE'
 *
...
$string['configgrade0'] = '對斷言進行負面評價的預設文字。';
$string['configgrade1'] = '對斷言進行正面評價的預設文字。';
...
$string['grade1'] = '「正確」表述為';
$string['grade1default'] = '是';
$string['grademapping'] = '成績對應表';
