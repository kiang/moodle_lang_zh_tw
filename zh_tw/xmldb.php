...
$string['binaryincorrectlength'] = '二進制欄位的長度不正確';
$string['cannotuseidfield'] = '不能插入「id」欄位。它是自動編號的列';
$string['change'] = '更改';
$string['charincorrectlength'] = '字元欄位的不正確長度';
$string['checkbigints'] = '檢查bigint類型數據';
$string['check_bigints'] = '查詢不正確 DB 整數';
$string['checkdefaults'] = '檢查預設值';
$string['check_defaults'] = '查找不一致的預設值';
$string['checkforeignkeys'] = '檢查外鍵';
$string['check_foreign_keys'] = '搜索無效的外鍵';
$string['checkindexes'] = '檢查索引';
$string['check_indexes'] = '查找缺失的資料庫索引';
$string['completelogbelow'] = '查看下面的完整日誌';
$string['confirmcheckbigints'] = '本功能將在您的Moodle伺服器搜索<a href="http://tracker.moodle.org/browse/MDL-11038">潛在的整數欄位錯誤</a>，自動生成（而不是執行！）正確定義您資料庫中的整數的SQL語句。<br /><br />
您可以拷貝這些語句到您慣用的SQL界面中安全地執行（不要忘記在此之前備份您的數據）。<br /><br />
在搜索之前，強烈建議使用您的Moodle發行版（1.8、1.9、2.x……）的最新版（帶+的版本）。<br /><br />
此功能不會對資料庫做任何寫操作（只是讀取），所以任何時候運行它都是安全的。';
$string['confirmcheckdefaults'] = '本功能將在您Moodle伺服器上搜索不一致的預設值，自動生成（而不是執行！）設置正確預設值的SQL語句。<br /><br />
您可以拷貝這些語句到您慣用的SQL界面中安全地執行（不要忘記在此之前備份您的數據）。<br /><br />
在搜索之前，強烈建議使用您的Moodle發行版（1.8、1.9、2.x……）的最新版（帶+的版本）。<br /><br />
此功能不會對資料庫做任何寫操作（只是讀取），所以任何時候運行它都是安全的。';
$string['confirmcheckforeignkeys'] = '本功能會掃描install.xml中定義的外鍵，尋找潛在的問題。（Moodle目前並不在資料庫中生成實際的外鍵限制，這就導致可能有無效的數據。）<br /><br />
在搜索之前，強烈建議使用您的Moodle發行版（1.8、1.9、2.x……）的最新版（帶+的版本）。<br /><br />
此功能不會對資料庫做任何寫操作（只是讀取），所以任何時候運行它都是安全的。';
$string['confirmcheckindexes'] = '本功能將查找您Moodle伺服器上潛在的缺失索引，自動生成（而不是執行！）修復這些問題的SQL語句。<br /><br />
您可以拷貝這些語句到您慣用的SQL界面中安全地執行（不要忘記在此之前備份您的數據）。<br /><br />
...
$string['enumvaluesincorrect'] = '枚舉欄位中不正確的值';
$string['expected'] = '預期';
$string['extensionrequired'] = '抱歉 - 此動作需要調用PHP擴展「{$a}」。如果您要使用此特性，請安裝此擴展。';
$string['field'] = '欄位';
$string['fieldnameempty'] = '欄位名為空';
$string['fields'] = '欄位';
$string['fieldsnotintable'] = '欄位在表中不存在';
$string['fieldsusedinindex'] = '此欄位被用做索引';
$string['fieldsusedinkey'] = '此欄位被用作主鍵。';
...
$string['float2numbernote'] = '注意：雖然XMLDB完全支持「float」欄位，但仍建議用「number」欄位代替它。';
$string['floatincorrectdecimals'] = '浮點欄位的小數位數不正確';
$string['floatincorrectlength'] = '浮點欄位的長度不正確';
...
$string['masterprimaryuniqueordernomatch'] = '您的外鍵中的所有欄位的定義順序，都必須與它們在對應的表中的 UNIQUE KEY 中的定義順序相同。';
$string['missing'] = '缺失';
...
$string['mysqlextracheckbigints'] = '如使用 MySQL 資料庫，它還將查找不正確的大整數標記。';
$string['newfield'] = '新建欄位';
$string['newindex'] = '新建索引';
$string['newkey'] = '新建鍵值';
$string['newtable'] = '建立新表';
$string['newtablefrommysql'] = '從 MySQL 建新表';
$string['new_table_from_mysql'] = '從 MySQL 建新表';
$string['nofieldsspecified'] = '未指定任何欄位';
$string['nomasterprimaryuniquefound'] = '您的外鍵對應的欄位必須是對應表中的主鍵或唯一鍵。注意，欄位只是 UNIQUE INDEX 是不夠的。';
$string['nomissingindexesfound'] = '沒有發現缺失的索引，您的資料庫不需要做任何操作。';
$string['noreffieldsspecified'] = '為指定任何對應欄位';
$string['noreftablespecified'] = '未找到對應欄位';
...
$string['pendingchangescannotbesaved'] = '此文件有修改，但不能保存！請確認Web伺服器對目錄和它裡面的install.xml文件都有寫權限。';
$string['pendingchangescannotbesavedreload'] = '此文件有修改，但不能保存！請確認Web伺服器對目錄和它裡面的install.xml文件都有寫權限。然後重新加載此頁，您就能保存這些變化了。';
...
$string['selectfieldkeyindex'] = '選擇欄位/主鍵/索引：';
$string['selectonecommand'] = '為了查看 PHP 代碼，請在列表中選擇一個動作';
$string['selectonefieldkeyindex'] = '為了查看 PHP 代碼，請在列表中選擇一個欄位/主鍵/索引';
...
$string['view_table_php'] = '查看錶 PHP';
$string['view_table_sql'] = '查看錶 SQL';
$string['viewxml'] = 'XML';
$string['violatedforeignkeys'] = '無效的外鍵';
$string['violatedforeignkeysfound'] = '發現無效的外鍵';
$string['violations'] = '違例';
$string['wrong'] = '錯誤';
$string['wrongdefaults'] = '錯誤的預設值';
$string['wrongints'] = '錯誤的整型數';
$string['wronglengthforenum'] = '枚舉欄位的長度不正確';
$string['wrongnumberofreffields'] = '對應欄位個數有誤';
$string['wrongreservedwords'] = '當前使用的保留字<br />（表名如果使用{$CFG->prefix}，就不用留意這個問題）';
$string['yesmissingindexesfound'] = '在資料庫中發現了缺失的索引。以下是詳細，需要執行 SQL 命令來修正(注意先備份)。<br /><br />我們強烈建議您在修改完成後，重新用此工具進行檢查以確認再沒有缺失的索引。';
$string['yeswrongdefaultsfound'] = '在資料庫中已經發現了不一致的預設值。以下是詳細資料，需要執行 SQL 命令來修正(注意先備份)。<br /><br />我們強烈建議您在修改完成後，重新用此工具進行檢查以確認沒有其它錯誤。';
$string['yeswrongintsfound'] = '在資料庫中已經發現了整形錯誤。以下是詳細資料，需要執行 SQL 命令來修正(注意先備份)。<br /><br />我們強烈建議您在修改完成後，重新用此工具進行檢查以確認沒有其它錯誤。';
